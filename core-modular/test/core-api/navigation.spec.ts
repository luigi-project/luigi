...
describe('Navigation', () => {
    ...
    describe('navigate with pathRouting enabled', () => {
        ...
        it('should open a path as modal', () => {
            ...
            expect(openModalSpy).toHaveBeenCalledWith(luigiMock, { pathSegment: 'home', label: 'Test Modal', children: [] }, modalSettings, undefined);
        });
    });
    describe('navigate with hashRouting enabled', () => {
        ...
        it('should open a path as modal', () => {
            ...
            expect(openModalSpy).toHaveBeenCalled();
            expect(openModalSpy).toHaveBeenCalledWith(luigiMock, { label: 'Test Modal', children: [] }, modalSettings, undefined);
        });
    });
