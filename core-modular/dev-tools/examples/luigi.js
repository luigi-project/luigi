...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = class {
	...
	set(e) {
		this.$value = e, this.$subscribers.forEach((t) => {
			t(e);
		});
	}
	update(e) {
	...
	subscribe(e) {
		return this.$subscribers.add(e), e(this.$value), () => {
...
var i = (/* @__PURE__ */ e(((e, t) => {
	(function() {
		var n, r = "4.18.1", i = 200, a = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.", o = "Expected a function", s = "Invalid `variable` option passed into `_.template`", c = "Invalid `imports` option passed into `_.template`", l = "__lodash_hash_undefined__", u = 500, d = "__lodash_placeholder__", f = 1, p = 2, m = 4, h = 1, g = 2, _ = 1, v = 2, y = 4, b = 8, x = 16, S = 32, C = 64, ee = 128, te = 256, ne = 512, re = 30, ie = "...", ae = 800, oe = 16, se = 1, ce = 2, le = 3, ue = Infinity, de = 9007199254740991, fe = 17976931348623157e292, pe = NaN, me = 4294967295, he = me - 1, ge = me >>> 1, _e = [
			...
			["partialRight", C],
			["rearg", te]
		], ve = "[object Arguments]", ye = "[object Array]", be = "[object AsyncFunction]", xe = "[object Boolean]", Se = "[object Date]", Ce = "[object DOMException]", we = "[object Error]", Te = "[object Function]", Ee = "[object GeneratorFunction]", De = "[object Map]", Oe = "[object Number]", ke = "[object Null]", Ae = "[object Object]", je = "[object Promise]", Me = "[object Proxy]", Ne = "[object RegExp]", Pe = "[object Set]", Fe = "[object String]", Ie = "[object Symbol]", Le = "[object Undefined]", Re = "[object WeakMap]", ze = "[object WeakSet]", Be = "[object ArrayBuffer]", w = "[object DataView]", Ve = "[object Float32Array]", He = "[object Float64Array]", Ue = "[object Int8Array]", We = "[object Int16Array]", Ge = "[object Int32Array]", Ke = "[object Uint8Array]", qe = "[object Uint8ClampedArray]", Je = "[object Uint16Array]", Ye = "[object Uint32Array]", Xe = /\b__p \+= '';/g, T = /\b(__p \+=) '' \+/g, Ze = /(__e\(.*?\)|\b__t\)) \+\n'';/g, Qe = /&(?:amp|lt|gt|quot|#39);/g, $e = /[&<>"']/g, et = RegExp(Qe.source), tt = RegExp($e.source), nt = /<%-([\s\S]+?)%>/g, rt = /<%([\s\S]+?)%>/g, it = /<%=([\s\S]+?)%>/g, at = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, ot = /^\w*$/, st = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, ct = /[\\^$.*+?()[\]{}|]/g, lt = RegExp(ct.source), ut = /^\s+/, E = /\s/, dt = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, ft = /\{\n\/\* \[wrapped with (.+)\] \*/, pt = /,? & /, mt = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, ht = /[()=,{}\[\]\/\s]/, gt = /\\(\\)?/g, _t = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, vt = /\w*$/, D = /^[-+]0x[0-9a-f]+$/i, yt = /^0b[01]+$/i, bt = /^\[object .+?Constructor\]$/, xt = /^0o[0-7]+$/i, St = /^(?:0|[1-9]\d*)$/, Ct = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, wt = /($^)/, Tt = /['\n\r\u2028\u2029\\]/g, Et = "\\ud800-\\udfff", Dt = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", Ot = "\\u2700-\\u27bf", O = "a-z\\xdf-\\xf6\\xf8-\\xff", k = "\\xac\\xb1\\xd7\\xf7", kt = "\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf", At = "\\u2000-\\u206f", jt = " \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", Mt = "A-Z\\xc0-\\xd6\\xd8-\\xde", Nt = "\\ufe0e\\ufe0f", Pt = k + kt + At + jt, Ft = "['’]", A = "[" + Et + "]", It = "[" + Pt + "]", Lt = "[" + Dt + "]", Rt = "\\d+", zt = "[" + Ot + "]", Bt = "[" + O + "]", Vt = "[^" + Et + Pt + Rt + Ot + O + Mt + "]", Ht = "\\ud83c[\\udffb-\\udfff]", Ut = "(?:" + Lt + "|" + Ht + ")", Wt = "[^" + Et + "]", Gt = "(?:\\ud83c[\\udde6-\\uddff]){2}", Kt = "[\\ud800-\\udbff][\\udc00-\\udfff]", qt = "[" + Mt + "]", Jt = "\\u200d", Yt = "(?:" + Bt + "|" + Vt + ")", Xt = "(?:" + qt + "|" + Vt + ")", Zt = "(?:" + Ft + "(?:d|ll|m|re|s|t|ve))?", Qt = "(?:" + Ft + "(?:D|LL|M|RE|S|T|VE))?", $t = Ut + "?", en = "[" + Nt + "]?", tn = "(?:" + Jt + "(?:" + [
			Wt,
			Gt,
			Kt
			...
			Rt,
			on
		].join("|"), "g"), fn = RegExp("[" + Jt + Et + Dt + Nt + "]"), pn = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, mn = /* @__PURE__ */ "Array.Buffer.DataView.Date.Error.Float32Array.Float64Array.Function.Int8Array.Int16Array.Int32Array.Map.Math.Object.Promise.RegExp.Set.String.Symbol.TypeError.Uint8Array.Uint8ClampedArray.Uint16Array.Uint32Array.WeakMap._.clearTimeout.isFinite.parseInt.setTimeout".split("."), hn = -1, j = {};
		j[Ve] = j[He] = j[Ue] = j[We] = j[Ge] = j[Ke] = j[qe] = j[Je] = j[Ye] = !0, j[ve] = j[ye] = j[Be] = j[xe] = j[w] = j[Se] = j[we] = j[Te] = j[De] = j[Oe] = j[Ae] = j[Ne] = j[Pe] = j[Fe] = j[Re] = !1;
		var M = {};
		M[ve] = M[ye] = M[Be] = M[w] = M[xe] = M[Se] = M[Ve] = M[He] = M[Ue] = M[We] = M[Ge] = M[De] = M[Oe] = M[Ae] = M[Ne] = M[Pe] = M[Fe] = M[Ie] = M[Ke] = M[qe] = M[Je] = M[Ye] = !0, M[we] = M[Te] = M[Re] = !1;
		var gn = {
			À: "A",
			Á: "A",
			Â: "A",
			...
			"\u2028": "u2028",
			"\u2029": "u2029"
		}, bn = parseFloat, xn = parseInt, Sn = typeof global == "object" && global && global.Object === Object && global, Cn = typeof self == "object" && self && self.Object === Object && self, wn = Sn || Cn || Function("return this")(), Tn = typeof e == "object" && e && !e.nodeType && e, En = Tn && typeof t == "object" && t && !t.nodeType && t, Dn = En && En.exports === Tn, On = Dn && Sn.process, kn = function() {
			try {
				return En && En.require && En.require("util").types || On && On.binding && On.binding("util");
			} catch {}
		}(), An = kn && kn.isArrayBuffer, jn = kn && kn.isDate, Mn = kn && kn.isMap, Nn = kn && kn.isRegExp, Pn = kn && kn.isSet, Fn = kn && kn.isTypedArray;
		function In(e, t, n) {
			switch (n.length) {
		...
		var Fr = (function e(t) {
			...
			var E = t.Array, mt = t.Date, Et = t.Error, Dt = t.Function, Ot = t.Math, O = t.Object, k = t.RegExp, kt = t.String, At = t.TypeError, jt = E.prototype, Mt = Dt.prototype, Nt = O.prototype, Pt = t["__core-js_shared__"], Ft = Mt.toString, A = Nt.hasOwnProperty, It = 0, Lt = function() {
				var e = /[^.]+$/.exec(Pt && Pt.keys && Pt.keys.IE_PROTO || "");
				return e ? "Symbol(src)_1." + e : "";
			}(), Rt = Nt.toString, zt = Ft.call(O), Bt = wn._, Vt = k("^" + Ft.call(A).replace(ct, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Ht = Dn ? t.Buffer : n, Ut = t.Symbol, Wt = t.Uint8Array, Gt = Ht ? Ht.allocUnsafe : n, Kt = Sr(O.getPrototypeOf, O), qt = O.create, Jt = Nt.propertyIsEnumerable, Yt = jt.splice, Xt = Ut ? Ut.isConcatSpreadable : n, Zt = Ut ? Ut.iterator : n, Qt = Ut ? Ut.toStringTag : n, $t = function() {
				try {
					var e = $o(O, "defineProperty");
					return e({}, "", {}), e;
				} catch {}
			}(), en = t.clearTimeout !== wn.clearTimeout && t.clearTimeout, tn = mt && mt.now !== wn.Date.now && mt.now, nn = t.setTimeout !== wn.setTimeout && t.setTimeout, rn = Ot.ceil, an = Ot.floor, on = O.getOwnPropertySymbols, sn = Ht ? Ht.isBuffer : n, un = t.isFinite, dn = jt.join, fn = Sr(O.keys, O), pn = Ot.max, gn = Ot.min, _n = mt.now, vn = t.parseInt, yn = Ot.random, Sn = jt.reverse, Cn = $o(t, "DataView"), Tn = $o(t, "Map"), En = $o(t, "Promise"), On = $o(t, "Set"), kn = $o(t, "WeakMap"), F = $o(O, "create"), qn = kn && new kn(), nr = {}, Er = Is(Cn), Mr = Is(Tn), Nr = Is(En), Ir = Is(On), Lr = Is(kn), Rr = Ut ? Ut.prototype : n, zr = Rr ? Rr.valueOf : n, Br = Rr ? Rr.toString : n;
			function L(e) {
			...
			function Gr() {
				var e = this.__wrapped__.value(), t = this.__dir__, n = Z(e), r = t < 0, i = n ? e.length : 0, a = is(0, i, this.__views__), o = a.start, s = a.end, c = s - o, l = r ? s : o - 1, u = this.__iteratees__, d = u.length, f = 0, p = gn(c, this.__takeCount__);
			...
			Kr.prototype.clear = qr, Kr.prototype.delete = B, Kr.prototype.get = Jr, Kr.prototype.has = V, Kr.prototype.set = Yr;
			function Xr(e) {
				var t = -1, n = e == null ? 0 : e.length;
				for (this.clear(); ++t < n;) {
					var r = e[t];
			...
			Xr.prototype.clear = Zr, Xr.prototype.delete = Qr, Xr.prototype.get = $r, Xr.prototype.has = ei, Xr.prototype.set = ti;
			function ni(e) {
				var t = -1, n = e == null ? 0 : e.length;
				for (this.clear(); ++t < n;) {
					var r = e[t];
			...
			ni.prototype.clear = ri, ni.prototype.delete = ii, ni.prototype.get = ai, ni.prototype.has = oi, ni.prototype.set = si;
			function ci(e) {
				var t = -1, n = e == null ? 0 : e.length;
			...
			di.prototype.clear = fi, di.prototype.delete = H, di.prototype.get = U, di.prototype.has = pi, di.prototype.set = mi;
			function hi(e, t) {
				var n = Z(e), r = !n && du(e), i = !n && !r && gu(e), a = !n && !r && !i && Uu(e), o = n || r || i || a, s = o ? or(e.length, kt) : [], c = s.length;
				for (var l in e) (t || A.call(e, l)) && !(o && (l == "length" || i && (l == "offset" || l == "parent") || a && (l == "buffer" || l == "byteLength" || l == "byteOffset") || fs(l, c))) && s.push(l);
				return s;
			}
			function gi(e) {
				var t = e.length;
			...
			function Xi(e, t, r) {
				for (var i = r ? Un : Hn, a = e[0].length, o = e.length, s = o, c = E(o), l = Infinity, u = []; s--;) {
					var d = e[s];
					s && t && (d = N(d, I(t))), l = gn(d.length, l), c[s] = !r && (t || a >= 120 && d.length >= 120) ? new ci(s && d) : n;
				}
				d = e[0];
				var f = -1, p = c[0];
			...
			function na(e, t, n, r, i) {
				return e === t ? !0 : e == null || t == null || !Ou(e) && !Ou(t) ? e !== e && t !== t : ra(e, t, n, r, na, i);
			}
			function ra(e, t, n, r, i, a) {
				var o = Z(e), s = Z(t), c = o ? ye : rs(e), l = s ? ye : rs(t);
				c = c == ve ? Ae : c, l = l == ve ? Ae : l;
				var u = c == Ae, d = l == Ae, f = c == l;
				if (f && gu(e)) {
					if (!gu(t)) return !1;
					o = !0, u = !1;
				}
			...
			function ua(e) {
				return typeof e == "function" ? e : e == null ? Mf : typeof e == "object" ? Z(e) ? ga(e[0], e[1]) : ha(e) : Gf(e);
			}
			function da(e) {
				if (!vs(e)) return fn(e);
				var t = [];
			...
			function ha(e) {
				var t = Qo(e);
				return t.length == 1 && t[0][2] ? X(t[0][0], t[0][1]) : function(n) {
					return n === e || aa(n, e, t);
				};
			}
			function ga(e, t) {
				return ms(e) && ys(t) ? X(Fs(e), t) : function(r) {
					var i = _d(r, e);
			...
			function va(e, t, r, i, a, o, s) {
				var c = Ds(e, r), l = Ds(t, r), u = s.get(l);
				if (u) {
					vi(e, r, u);
					return;
				}
				...
				if (f) {
					...
					d = l, p || m || h ? Z(c) ? d = c : mu(c) ? d = uo(c) : m ? (f = !1, d = to(l, !0)) : h ? (f = !1, d = oo(l, !0)) : d = [] : Lu(l) || du(l) ? (d = c, du(c) ? d = $u(c) : (!Du(c) || wu(c)) && (d = cs(l))) : f = !1;
				}
			...
			function ba(e, t, n) {
				...
				var r = -1;
				return t = N(t, I(J())), ir(ma(e, function(e, n, i) {
					return {
			...
			function wa(e, t, n, r) {
				...
				for (e === t && (t = uo(t)), n && (s = N(e, I(n))); ++a < o;) for (var c = 0, l = t[a], u = n ? n(l) : l; (c = i(s, u, c, r)) > -1;) s !== e && Yt.call(s, c, 1), Yt.call(e, c, 1);
				return e;
			}
			function Ta(e, t) {
			...
			var Ma = qn ? function(e, t) {
				return qn.set(e, t), e;
			} : Mf, Na = $t ? function(e, t) {
				return $t(e, "toString", {
					configurable: !0,
					enumerable: !1,
					value: Of(t),
			...
			function Ra(e, t, r, i) {
				...
				for (var s = t !== t, c = t === null, l = Hu(t), u = t === n; a < o;) {
					var d = an((a + o) / 2), f = r(e[d]), p = f !== n, m = f === null, h = f === f, g = Hu(f);
					if (s) var _ = i || h;
			...
			function Ka(e, t) {
				var n = e;
				return n instanceof R && (n = n.value()), P(t, function(e, t) {
			...
			function qa(e, t, n) {
				...
				for (var i = -1, a = E(r); ++i < r;) for (var o = e[i], s = -1; ++s < r;) s != i && (a[i] = Ai(a[i] || o, e[s], t, n));
			...
			function co(e, t, n, r) {
				for (var i = -1, a = e.length, o = n.length, s = -1, c = t.length, l = pn(a - o, 0), u = E(c + l), d = !r; ++s < c;) u[s] = t[s];
				for (; ++i < o;) (d || i < a) && (u[n[i]] = e[i]);
				for (; l--;) u[s++] = e[i++];
				return u;
			}
			function lo(e, t, n, r) {
				for (var i = -1, a = e.length, o = -1, s = n.length, c = -1, l = t.length, u = pn(a - s, 0), d = E(u + l), f = !r; ++i < u;) d[i] = e[i];
			...
			function go(e) {
				return K(function(t, r) {
					...
					for (o = e.length > 3 && typeof o == "function" ? (a--, o) : n, s && ps(r[0], r[1], s) && (o = a < 3 ? n : o, a = 1), t = O(t); ++i < a;) {
						var c = r[i];
						c && e(t, c, i, o);
					}
					return t;
			...
			function bo(e) {
				return function(t) {
					t = $(t);
					var r = vr(t) ? kr(t) : n, i = r ? r[0] : t.charAt(0), a = r ? $a(r, 1).join("") : t.slice(1);
					return i[e]() + a;
				};
			}
			function xo(e) {
			...
			function Co(e, t, r) {
				...
				function a() {
					...
					return o -= u.length, o < r ? Po(e, t, Eo, a.placeholder, n, s, u, n, n, r - o) : In(this && this !== wn && this instanceof a ? i : e, this, s);
				}
				return a;
			}
			function wo(e) {
			...
			function To(e) {
				return Go(function(t) {
					...
					for (i = c ? i : r; ++i < r;) {
						...
						c = u && gs(u[0]) && u[1] == (ee | b | S | te) && !u[4].length && u[9] == 1 ? c[Yo(u[0])].apply(c, u[3]) : s.length == 1 && gs(s) ? c[l]() : c.thru(s);
					}
					return function() {
			...
			function Eo(e, t, r, i, a, o, s, c, l, u) {
				var d = t & ee, f = t & _, p = t & v, m = t & (b | x), h = t & ne, g = p ? n : So(e);
				function y() {
					for (var n = arguments.length, _ = E(n), v = n; v--;) _[v] = arguments[v];
					if (m) var b = Xo(y), x = pr(_, b);
					if (i && (_ = co(_, i, a, m)), o && (_ = lo(_, o, s, m)), n -= x, m && n < u) {
						var S = Cr(_, b);
						return Po(e, t, Eo, y.placeholder, r, _, S, c, l, u - n);
					}
					var C = f ? r : this, ee = p ? C[e] : e;
					return n = _.length, c ? _ = Es(_, c) : h && n > 1 && _.reverse(), d && l < n && (_.length = l), this && this !== wn && this instanceof y && (ee = g || So(ee)), ee.apply(C, _);
				}
				return y;
			}
			function Do(e, t) {
			...
			function Oo(e, t) {
				return function(r, i) {
					...
					if (r !== n && (a = r), i !== n) {
						if (a === n) return i;
						typeof r == "string" || typeof i == "string" ? (r = Va(r), i = Va(i)) : (r = Ba(r), i = Ba(i)), a = e(r, i);
					}
					return a;
				};
			}
			...
			function jo(e, t, n, r) {
				var i = t & _, a = So(e);
				function o() {
					for (var t = -1, s = arguments.length, c = -1, l = r.length, u = E(l + s), d = this && this !== wn && this instanceof o ? a : e; ++c < l;) u[c] = r[c];
			...
			function Mo(e) {
				return function(t, r, i) {
					return i && typeof i != "number" && ps(t, r, i) && (r = i = n), t = Xu(t), r === n ? (r = t, t = 0) : r = Xu(r), i = i === n ? t < r ? 1 : -1 : Xu(i), Da(t, r, i, e);
				};
			}
			function No(e) {
				return function(t, n) {
			...
			var Io = On && 1 / wr(new On([, -0]))[1] == ue ? function(e) {
				return new On(e);
			} : Bf;
			function Lo(e) {
				return function(t) {
			...
			function Ro(e, t, r, i, a, s, c, l) {
				...
				var d = i ? i.length : 0;
				if (d || (t &= ~(S | C), i = a = n), c = c === n ? c : pn(Q(c), 0), l = l === n ? l : Q(l), d -= a ? a.length : 0, t & C) {
					var f = i, p = a;
					i = a = n;
				}
				var m = u ? n : Jo(e), h = [
				...
				if (m && xs(h, m), e = h[0], t = h[1], r = h[2], i = h[3], a = h[4], l = h[9] = h[9] === n ? u ? 0 : e.length : pn(h[9] - d, 0), !l && t & (b | x) && (t &= ~(b | x)), !t || t == _) var g = yo(e, t, r);
			...
			function Uo(e, t, n, r, i, a, o) {
				switch (n) {
					...
					case Be: return !(e.byteLength != t.byteLength || !a(new Wt(e), new Wt(t)));
					case xe:
					case Se:
					case Oe: return cu(+e, +t);
					...
					case Pe:
						...
						return o.delete(e), u;
					case Ie: if (zr) return zr.call(e) == zr.call(t);
				}
				return !1;
			}
			...
			var ts = on ? function(e) {
				return e == null ? [] : (e = O(e), Vn(on(e), function(t) {
					return Jt.call(e, t);
				}));
			} : Yf, ns = on ? function(e) {
			...
			(Cn && rs(new Cn(/* @__PURE__ */ new ArrayBuffer(1))) != w || Tn && rs(new Tn()) != De || En && rs(En.resolve()) != je || On && rs(new On()) != Pe || kn && rs(new kn()) != Re) && (rs = function(e) {
				var t = Gi(e), r = t == Ae ? e.constructor : n, i = r ? Is(r) : "";
				if (i) switch (i) {
					case Er: return w;
					case Mr: return De;
					case Nr: return je;
			...
			function ls(e, t, n) {
				...
				switch (t) {
					...
					case qe:
					case Je:
					case Ye: return oo(e, n);
					case De: return new r();
					case Oe:
					case Fe: return new r(e);
					case Ne: return io(e);
			...
			function ms(e, t) {
				if (Z(e)) return !1;
				var n = typeof e;
				return n == "number" || n == "symbol" || n == "boolean" || e == null || Hu(e) ? !0 : ot.test(e) || !at.test(e) || t != null && e in O(t);
			}
			function hs(e) {
				var t = typeof e;
			...
			function xs(e, t) {
				var n = e[1], r = t[1], i = n | r, a = i < (_ | v | ee), o = r == ee && n == b || r == ee && n == te && e[7].length <= t[8] || r == (ee | te) && t[7].length <= t[8] && n == b;
				if (!(a || o)) return e;
				...
				return s = t[5], s && (c = e[5], e[5] = c ? lo(c, s, t[6]) : s, e[6] = c ? Cr(e[5], d) : t[6]), s = t[7], s && (e[7] = s), r & ee && (e[8] = e[8] == null ? t[8] : gn(e[8], t[8])), e[9] ??= t[9], e[0] = t[0], e[1] = i, e;
			}
			function Ss(e) {
				var t = [];
			...
			function ws(e, t, r) {
				return t = pn(t === n ? e.length - 1 : t, 0), function() {
			...
			var Os = Ms(Ma), ks = nn || function(e, t) {
			...
			var Ps = bs(function(e) {
				var t = [];
				return e.charCodeAt(0) === 46 && t.push(""), e.replace(st, function(e, n, r, i) {
			...
			function uc(e, t, r) {
				...
				if (!i) return -1;
				var a = i;
				return r !== n && (a = Q(r), a = a < 0 ? pn(i + a, 0) : gn(a, i - 1)), t === t ? Dr(e, t, a) : Xn(e, $n, a, !0);
			}
			function dc(e, t) {
			...
			var gc = Go(function(e, t) {
				var n = e == null ? 0 : e.length, r = Ti(e, t);
				return Ta(e, N(t, function(e) {
					return fs(e, n) ? +e : e;
				}).sort(q)), r;
			});
			function _c(e, t) {
			...
			function yc(e, t, r) {
				var i = e == null ? 0 : e.length;
				return i ? (r && typeof r != "number" && ps(e, t, r) ? (t = 0, r = i) : (t = t == null ? 0 : Q(t), r = r === n ? i : Q(r)), Fa(e, t, r)) : [];
			}
			function bc(e, t) {
				return La(e, t);
			}
			...
			var Qc = Go(function(e) {
				...
				return t > 1 || this.__actions__.length || !(i instanceof R) || !fs(r) ? this.thru(a) : (i = i.slice(r, +r + +!!t), i.__actions__.push({
					func: Zc,
					args: [a],
					thisArg: n
			...
			var vl = K(function(e, t, n) {
				var r = -1, i = typeof t == "function", a = pu(e) ? E(e.length) : [];
			...
			function xl(e, t, r, i) {
				return e == null ? [] : (Z(t) || (t = t == null ? [] : [t]), r = i ? n : r, Z(r) || (r = r == null ? [] : [r]), ba(e, t, r));
			}
			var Sl = ho(function(e, t, n) {
				e[+!n].push(t);
			}, function() {
				return [[], []];
			});
			function Cl(e, t, n) {
				var r = Z(e) ? P : rr, i = arguments.length < 3;
				return r(e, J(t, 4), n, i, ji);
			}
			function wl(e, t, n) {
				var r = Z(e) ? Gn : rr, i = arguments.length < 3;
			...
			var jl = K(function(e, t) {
				if (e == null) return [];
				var n = t.length;
				return n > 1 && ps(e, t[0], t[1]) ? t = [] : n > 2 && ps(t[0], t[1], t[2]) && (t = [t[0]]), ba(e, Li(t, 1), []);
			}), Ml = tn || function() {
				return wn.Date.now();
			};
			function Nl(e, t) {
			...
			function Bl(e, t, r) {
				...
				if (typeof e != "function") throw new At(o);
				t = Qu(t) || 0, Du(r) && (f = !!r.leading, p = "maxWait" in r, s = p ? pn(Qu(r.maxWait) || 0, t) : s, m = "trailing" in r ? !!r.trailing : m);
				function h(t) {
					var r = i, o = a;
			...
			function Ql(e, t) {
				if (typeof e != "function") throw new At(o);
				return t = t == null ? 0 : pn(Q(t), 0), K(function(n) {
					var r = n[t], i = $a(n, 0, t);
			...
			var lu = No(Ki), uu = No(function(e, t) {
				return e >= t;
			}), du = $i(function() {
				return arguments;
			}()) ? $i : function(e) {
				return Ou(e) && A.call(e, "callee") && !Jt.call(e, "callee");
			}, Z = E.isArray, fu = An ? I(An) : ea;
			function pu(e) {
			...
			var qu = No(pa), Ju = No(function(e, t) {
				return e <= t;
			});
			function Yu(e) {
				if (!e) return [];
			...
			function Md(e, t) {
				...
				return t = J(t), Sa(e, n, function(e, n) {
					return t(e, n[0]);
				});
			}
			function Nd(e, t, r) {
			...
			function Rd(e, t, n) {
				...
				return (i ? Rn : Bi)(e, function(e, r, i) {
					return t(n, e, r, i);
				}), n;
			}
			function zd(e, t) {
			...
			function Wd(e, t, r) {
				return r === n && (r = t, t = n), r !== n && (r = Qu(r), r = r === r ? r : 0), t !== n && (t = Qu(t), t = t === t ? t : 0), Ei(Qu(e), t, r);
			}
			function Gd(e, t, r) {
				return t = Xu(t), r === n ? (r = t, t = 0) : r = Xu(r), e = Qu(e), Yi(e, t, r);
			}
			function Kd(e, t, r) {
				if (r && typeof r != "boolean" && ps(e, t, r) && (t = r = n), r === n && (typeof t == "boolean" ? (r = t, t = n) : typeof e == "boolean" && (r = e, e = n)), e === n && t === n ? (e = 0, t = 1) : (e = Xu(e), t === n ? (t = e, e = 0) : t = Xu(t)), e > t) {
					var i = e;
					e = t, t = i;
				}
				if (r || e % 1 || t % 1) {
			...
			function uf(e, t, r) {
				return r && typeof r != "number" && ps(e, t, r) && (t = r = n), r = r === n ? me : r >>> 0, r ? (e = $(e), e && (typeof t == "string" || t != null && !Ru(t)) && (t = Va(t), !t && vr(e)) ? $a(kr(e), 0, r) : e.split(t, r)) : [];
			}
			...
			function pf(e, t, r) {
				...
				var a = id({}, t.imports, i.imports, zo), o = Cd(a), l = lr(a, o);
				Rn(o, function(e) {
					if (ht.test(e)) throw new Et(c);
				});
				var u, d, f = 0, p = t.interpolate || wt, m = "__p += '", h = k((t.escape || wt).source + "|" + p.source + "|" + (p === it ? _t : wt).source + "|" + (t.evaluate || wt).source + "|$", "g"), g = "//# sourceURL=" + (A.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++hn + "]") + "\n";
				...
				m = (d ? m.replace(Xe, "") : m).replace(T, "$1").replace(Ze, "$1;"), m = "function(" + (_ || "obj") + ") {\n" + (_ ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (u ? ", __e = _.escape" : "") + (d ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + m + "return __p\n}";
				var v = wf(function() {
			...
			function yf(e, t) {
				...
				if (s && (c += l.length - c), Ru(a)) {
					if (e.slice(c).search(a)) {
						var u, d = l;
						for (a.global || (a = k(a.source, $(vt.exec(a)) + "g")), a.lastIndex = 0; u = a.exec(d);) var f = u.index;
						l = l.slice(0, f === n ? c : f);
					}
			...
			function Bf() {}
			function Vf(e) {
				return e = Q(e), K(function(t) {
					return ya(t, e);
				});
			}
			var Hf = ko(N), Uf = ko(Bn), Wf = ko(Kn);
			function Gf(e) {
			...
			return L.after = Nl, L.ary = Pl, L.assign = td, L.assignIn = nd, L.assignInWith = rd, L.assignWith = id, L.at = ad, L.before = Fl, L.bind = Il, L.bindAll = Tf, L.bindKey = Ll, L.castArray = nu, L.chain = Yc, L.chunk = zs, L.compact = Bs, L.concat = Vs, L.cond = Ef, L.conforms = Df, L.constant = Of, L.countBy = ol, L.create = od, L.curry = Rl, L.curryRight = zl, L.debounce = Bl, L.defaults = sd, L.defaultsDeep = cd, L.defer = Vl, L.delay = Hl, L.difference = Hs, L.differenceBy = Us, L.differenceWith = Ws, L.drop = Gs, L.dropRight = Ks, L.dropRightWhile = qs, L.dropWhile = Js, L.fill = Ys, L.filter = cl, L.flatMap = dl, L.flatMapDeep = fl, L.flatMapDepth = pl, L.flatten = Qs, L.flattenDeep = $s, L.flattenDepth = ec, L.flip = Ul, L.flow = Af, L.flowRight = jf, L.fromPairs = tc, L.functions = hd, L.functionsIn = gd, L.groupBy = gl, L.initial = ic, L.intersection = ac, L.intersectionBy = oc, L.intersectionWith = sc, L.invert = bd, L.invertBy = xd, L.invokeMap = vl, L.iteratee = Nf, L.keyBy = yl, L.keys = Cd, L.keysIn = wd, L.map = bl, L.mapKeys = Td, L.mapValues = Ed, L.matches = Pf, L.matchesProperty = Ff, L.memoize = Wl, L.merge = Dd, L.mergeWith = Od, L.method = If, L.methodOf = Lf, L.mixin = Rf, L.negate = Gl, L.nthArg = Vf, L.omit = kd, L.omitBy = Ad, L.once = Kl, L.orderBy = xl, L.over = Hf, L.overArgs = ql, L.overEvery = Uf, L.overSome = Wf, L.partial = Jl, L.partialRight = Yl, L.partition = Sl, L.pick = jd, L.pickBy = Md, L.property = Gf, L.propertyOf = Kf, L.pull = fc, L.pullAll = pc, L.pullAllBy = mc, L.pullAllWith = hc, L.pullAt = gc, L.range = qf, L.rangeRight = Jf, L.rearg = Xl, L.reject = Tl, L.remove = _c, L.rest = Zl, L.reverse = vc, L.sampleSize = Dl, L.set = Pd, L.setWith = Fd, L.shuffle = Ol, L.slice = yc, L.sortBy = jl, L.sortedUniq = Ec, L.sortedUniqBy = Dc, L.split = uf, L.spread = Ql, L.tail = Oc, L.take = kc, L.takeRight = Ac, L.takeRightWhile = jc, L.takeWhile = Mc, L.tap = Xc, L.throttle = $l, L.thru = Zc, L.toArray = Yu, L.toPairs = Id, L.toPairsIn = Ld, L.toPath = tp, L.toPlainObject = $u, L.transform = Rd, L.unary = eu, L.union = Nc, L.unionBy = Pc, L.unionWith = Fc, L.uniq = Ic, L.uniqBy = Lc, L.uniqWith = Rc, L.unset = zd, L.unzip = zc, L.unzipWith = Bc, L.update = Bd, L.updateWith = Vd, L.values = Hd, L.valuesIn = Ud, L.without = Vc, L.words = Cf, L.wrap = tu, L.xor = Hc, L.xorBy = Uc, L.xorWith = Wc, L.zip = Gc, L.zipObject = Kc, L.zipObjectDeep = qc, L.zipWith = Jc, L.entries = Id, L.entriesIn = Ld, L.extend = nd, L.extendWith = rd, Rf(L, L), L.add = rp, L.attempt = wf, L.camelCase = qd, L.capitalize = Jd, L.ceil = ip, L.clamp = Wd, L.clone = ru, L.cloneDeep = au, L.cloneDeepWith = ou, L.cloneWith = iu, L.conformsTo = su, L.deburr = Yd, L.defaultTo = kf, L.divide = ap, L.endsWith = Xd, L.eq = cu, L.escape = Zd, L.escapeRegExp = Qd, L.every = sl, L.find = ll, L.findIndex = Xs, L.findKey = ld, L.findLast = ul, L.findLastIndex = Zs, L.findLastKey = ud, L.floor = op, L.forEach = ml, L.forEachRight = hl, L.forIn = dd, L.forInRight = fd, L.forOwn = pd, L.forOwnRight = md, L.get = _d, L.gt = lu, L.gte = uu, L.has = vd, L.hasIn = yd, L.head = nc, L.identity = Mf, L.includes = _l, L.indexOf = rc, L.inRange = Gd, L.invoke = Sd, L.isArguments = du, L.isArray = Z, L.isArrayBuffer = fu, L.isArrayLike = pu, L.isArrayLikeObject = mu, L.isBoolean = hu, L.isBuffer = gu, L.isDate = _u, L.isElement = vu, L.isEmpty = yu, L.isEqual = bu, L.isEqualWith = xu, L.isError = Su, L.isFinite = Cu, L.isFunction = wu, L.isInteger = Tu, L.isLength = Eu, L.isMap = ku, L.isMatch = Au, L.isMatchWith = ju, L.isNaN = Mu, L.isNative = Nu, L.isNil = Fu, L.isNull = Pu, L.isNumber = Iu, L.isObject = Du, L.isObjectLike = Ou, L.isPlainObject = Lu, L.isRegExp = Ru, L.isSafeInteger = zu, L.isSet = Bu, L.isString = Vu, L.isSymbol = Hu, L.isTypedArray = Uu, L.isUndefined = Wu, L.isWeakMap = Gu, L.isWeakSet = Ku, L.join = cc, L.kebabCase = $d, L.last = lc, L.lastIndexOf = uc, L.lowerCase = ef, L.lowerFirst = tf, L.lt = qu, L.lte = Ju, L.max = sp, L.maxBy = cp, L.mean = lp, L.meanBy = up, L.min = dp, L.minBy = fp, L.stubArray = Yf, L.stubFalse = Xf, L.stubObject = Zf, L.stubString = Qf, L.stubTrue = $f, L.multiply = pp, L.nth = dc, L.noConflict = zf, L.noop = Bf, L.now = Ml, L.pad = nf, L.padEnd = rf, L.padStart = af, L.parseInt = of, L.random = Kd, L.reduce = Cl, L.reduceRight = wl, L.repeat = sf, L.replace = cf, L.result = Nd, L.round = mp, L.runInContext = e, L.sample = El, L.size = kl, L.snakeCase = lf, L.some = Al, L.sortedIndex = bc, L.sortedIndexBy = xc, L.sortedIndexOf = Sc, L.sortedLastIndex = Cc, L.sortedLastIndexBy = wc, L.sortedLastIndexOf = Tc, L.startCase = df, L.startsWith = ff, L.subtract = hp, L.sum = gp, L.sumBy = _p, L.template = pf, L.times = ep, L.toFinite = Xu, L.toInteger = Q, L.toLength = Zu, L.toLower = mf, L.toNumber = Qu, L.toSafeInteger = ed, L.toString = $, L.toUpper = hf, L.trim = gf, L.trimEnd = _f, L.trimStart = vf, L.truncate = yf, L.unescape = bf, L.uniqueId = np, L.upperCase = xf, L.upperFirst = Sf, L.each = ml, L.eachRight = hl, L.first = nc, Rf(L, function() {
				var e = {};
				return Bi(L, function(t, n) {
					A.call(L.prototype, n) || (e[n] = t);
				}), e;
			}(), { chain: !1 }), L.VERSION = r, Rn([
				"bind",
				"bindKey",
				"curry",
				"curryRight",
				...
				e = Q(e);
				var r = this;
				return r.__filtered__ && (e > 0 || t < 0) ? new R(r) : (e < 0 ? r = r.takeRight(-e) : e && (r = r.drop(e)), t !== n && (t = Q(t), r = t < 0 ? r.dropRight(-t) : r.take(t - e)), r);
				...
				a && (L.prototype[t] = function() {
					var t = this.__wrapped__, s = i ? [1] : arguments, c = t instanceof R, l = s[0], u = c || Z(t), d = function(e) {
				...
				name: "wrapper",
				func: n
			}], R.prototype.clone = z, R.prototype.reverse = Wr, R.prototype.value = Gr, L.prototype.at = Qc, L.prototype.chain = $c, L.prototype.commit = el, L.prototype.next = tl, L.prototype.plant = rl, L.prototype.reverse = il, L.prototype.toJSON = L.prototype.valueOf = L.prototype.value = al, L.prototype.first = L.prototype.head, Zt && (L.prototype[Zt] = nl), L;
		})();
		typeof define == "function" && typeof define.amd == "object" && define.amd ? (wn._ = Fr, define(function() {
			return Fr;
		})) : En ? ((En.exports = Fr)._ = Fr, Tn._ = Fr) : wn._ = Fr;
	}).call(e);
})))(), a = {
	...
	getNodeList: (e, t = !1) => {
		let n = [];
		return e && Array.from(document.querySelectorAll(e)).forEach((e) => {
	...
	removeProperties(e, t) {
		...
		for (let r in e) if (e.hasOwnProperty(r)) {
			let i = t.filter((e) => r.includes(e)).length === 0, a = t.filter((e) => e.endsWith("*")).map((e) => e.slice(0, -1)).filter((e) => r.startsWith(e)).length === 0;
			i && a && (n[r] = e[r]);
		}
		return n;
	},
	replaceVars(e, t, n, r = !0, a = !1) {
		let o = e;
		if (t) if (r) o = (0, i.replace)(o, /{([\s\S]+?)}/g, (e) => {
			let r = e.slice(1, -1).trim();
			return r.indexOf(n) === 0 && (r = r.substring(n.length)), (0, i.get)(t, r, e);
		});
		else {
			let e = a ? " " : "";
			o = o.replace(/\//g, e + "/") + e, Array.from(Object.entries(t)).sort((e, t) => t[0].length - e[0].length).forEach((t) => {
	...
	_setStore(e, t) {
		switch (this.getStorageType()) {
			case "localStorage":
			case "sessionStorage":
				t === void 0 ? this._getWebStorage(this.getStorageType()).removeItem(e) : this._getWebStorage(this.getStorageType()).setItem(e, JSON.stringify(t));
				break;
			case "none":
				this._internalStorage[e] = t;
				break;
			default: console.error(this._invalidStorageMsg);
		}
	}
	_getStore(e) {
		try {
			switch (this.getStorageType()) {
				case "localStorage":
				case "sessionStorage": return JSON.parse(this._getWebStorage(this.getStorageType()).getItem(e));
				case "none": return this._internalStorage[e];
				default: console.error(this._invalidStorageMsg);
			}
		} catch {
	...
	async handleAuthEvent(e, t, n, r) {
		let i = await s.executeConfigFnAsync("auth.events." + e, !1, t, n), a = i === void 0 || !!i;
		if (a && r) {
	...
	get store() {
		return s.getLuigi()?.initialized || console.warn("Luigi Core is not initialized yet. Consider moving your code to the luigiAfterInit lifecycle hook. Documentation: https://docs.luigi-project.io/docs/lifecycle-hooks"), {
	...
	parseUrlAuthErrors() {
		let e = a.getUrlParameter("error"), t = a.getUrlParameter("errorDescription");
		if (e) return {
			error: e,
			errorDescription: t
		};
	...
	async handleUrlAuthErrors(e, t, n) {
		return t ? await l.handleAuthEvent("onAuthError", e, {
			error: t,
			errorDescription: n
		}, e.logoutUrl + "?post_logout_redirect_uri=" + e.post_logout_redirect_uri + "&error=" + encodeURIComponent(t) + "&errorDescription=" + encodeURIComponent(n || "")) : !0;
	}
}();
//#endregion
...
var d = !1;
d = !0;
var f = {}, p = Symbol(), m = Symbol("filename"), h = globalThis.process?.env?.NODE_ENV, g = h && !h.toLowerCase().startsWith("prod"), _ = Array.isArray, v = Array.prototype.indexOf, y = Array.prototype.includes, b = Array.from, x = Object.keys, S = Object.defineProperty, C = Object.getOwnPropertyDescriptor, ee = Object.getOwnPropertyDescriptors, te = Object.prototype, ne = Array.prototype, re = Object.getPrototypeOf, ie = Object.isExtensible, ae = () => {};
function oe(e) {
	return e();
}
function se(e) {
...
var le = 16, ue = 32, de = 64, fe = 512, pe = 1024, me = 2048, he = 4096, ge = 8192, _e = 16384, ve = 32768, ye = 1 << 25, be = 65536, xe = 1 << 17, Se = 1 << 19, Ce = 65536, we = 1 << 21, Te = 1 << 22, Ee = 1 << 23, De = Symbol("$state"), Oe = Symbol("legacy props"), ke = Symbol("proxy path"), Ae = Symbol("attributes"), je = Symbol("class"), Me = Symbol("style"), Ne = Symbol("text"), Pe = Symbol("hmr anchor"), Fe = new class extends Error {
	name = "StaleReactionError";
	message = "The reaction that called `getAbortSignal()` was re-run or destroyed";
}();
function Ie(e) {
	if (g) {
		let t = /* @__PURE__ */ Error(`lifecycle_outside_component\n\`${e}(...)\` can only be used during component initialisation\nhttps://svelte.dev/e/lifecycle_outside_component`);
		throw t.name = "Svelte error", t;
	}
	throw Error("https://svelte.dev/e/lifecycle_outside_component");
}
var Le = "font-weight: bold", Re = "font-weight: normal";
function ze(e) {
	g ? console.warn(`%c[svelte] hydration_mismatch\n%c${e ? `Hydration failed because the initial UI does not match what was rendered on the server. The error occurred near ${e}` : "Hydration failed because the initial UI does not match what was rendered on the server"}\nhttps://svelte.dev/e/hydration_mismatch`, Le, Re) : console.warn("https://svelte.dev/e/hydration_mismatch");
}
function Be(e) {
	g ? console.warn(`%c[svelte] state_proxy_equality_mismatch\n%cReactive \`$state(...)\` proxies and the values they proxy have different identities. Because of this, comparisons with \`${e}\` will produce unexpected results\nhttps://svelte.dev/e/state_proxy_equality_mismatch`, Le, Re) : console.warn("https://svelte.dev/e/state_proxy_equality_mismatch");
}
var w, Ve = !1;
function He(e) {
	Ve = e;
...
function Xe(e) {
	let t = /* @__PURE__ */ Error(), n = function() {
...
function ut(e) {
	...
	if (g && e instanceof Error && !lt.has(e) && lt.set(e, function(e, t) {
		let n = C(e, "message");
		if (!(n && !n.configurable)) {
	...
	}(e, t)), (t.f & ve) === 0 && !(4 & t.f)) throw g && !t.parent && e instanceof Error && dt(e), e;
	E(e, t);
}
function E(e, t) {
	for (; t !== null;) {
...
var _t = !1, vt = null, D = null, yt = null, bt = null, xt = null, St = !1, Ct = !1, wt = null, Tt = null, Et = 0, Dt = /* @__PURE__ */ new Set(), Ot = 1, O = class e {
	id = Ot++;
	#e = !1;
	linked = !0;
	#t = null;
	...
	#_() {
		if (this.#e = !0, Et++ > 1e3 && (this.#C(), function() {
			if (g) {
				var e = /* @__PURE__ */ new Map();
				for (let n of D.current.keys()) for (let [r, i] of n.updated ?? []) {
					var t = e.get(r);
					t || (t = {
						error: i.error,
						count: 0
		...
		}()), g) for (let e of this.current.keys()) Dt.add(e);
		if (!this.#g()) {
	...
	capture(e, t, n = !1) {
		e.v === p || this.previous.has(e) || this.previous.set(e, e.v), (e.f & Ee) === 0 && (this.current.set(e, [t, n]), bt?.set(e, t)), this.is_fork || (e.v = t);
	}
	activate() {
		D = this;
	}
	...
	flush() {
		try {
			...
			if (Et = 0, xt = null, wt = null, Tt = null, Ct = !1, D = null, bt = null, Zt.clear(), g) for (let e of Dt) e.updated = null;
		}
	}
	discard() {
...
function At(e) {
	...
	if (t !== 0) {
		for (var n = 0; n < t;) {
			var r = e[n++];
			if (!(24576 & r.f) && rr(r) && (kt = /* @__PURE__ */ new Set(), cr(r), r.deps === null && r.first === null && r.nodes === null && r.teardown === null && r.ac === null && Ln(r), kt?.size > 0)) {
				Zt.clear();
				for (let e of kt) {
...
var A = class {
	...
	#h = function(e) {
		let t, n = 0, r = en(0);
		return g && Je(r, "createSubscriber version"), () => {
			En() && (I(r), jn(() => (n === 0 && (t = dr(() => e(() => cn(r)))), n += 1, () => {
				st(() => {
					--n, n === 0 && (t?.(), t = void 0, cn(r));
				});
			})));
		};
	}(() => (this.#m = en(this.#l), g && Je(this.#m, "$effect.pending()"), () => {
		this.#m = null;
	}));
	constructor(e, t, n, r) {
		...
		}, this.parent = F.b, this.transform_error = r ?? this.parent?.transform_error ?? ((e) => e), this.#i = Mn(() => {
			if (Ve) {
				let e = this.#t;
				We();
				let t = e.data === "[!";
	...
	#v() {
		...
		e && (this.is_pending = !0, this.#o = Nn(() => e(this.#e)), st(() => {
			var e = this.#c = document.createDocumentFragment(), t = vn();
			e.append(t), this.#a = this.#x(() => Nn(() => this.#r(t))), this.#u === 0 && (this.#e.before(e), this.#c = null, Rn(this.#o, () => {
				this.#o = null;
			}), this.#b(D));
		}));
	}
	...
	#S(e, t) {
		this.has_pending_snippet() ? (this.#u += e, this.#u === 0 && (this.#b(t), this.#o && Rn(this.#o, () => {
			this.#o = null;
		}), this.#c &&= (this.#e.before(this.#c), null))) : this.parent && this.parent.#S(e, t);
	}
	update_pending_count(e, t) {
		this.#S(e, t), this.#l += e, this.#m && !this.#d && (this.#d = !0, st(() => {
	...
	error(e) {
		...
		D?.is_fork ? (this.#a && D.skip_effect(this.#a), this.#o && D.skip_effect(this.#o), this.#s && D.skip_effect(this.#s), D.on_fork_commit(() => {
			this.#C(e);
		})) : this.#C(e);
	}
	#C(e) {
		this.#a &&= (In(this.#a), null), this.#o &&= (In(this.#o), null), this.#s &&= (In(this.#s), null), Ve && (Ue(this.#t), function(e = 1) {
			if (Ve) {
		...
		var r = !1, i = !1;
		let a = () => {
			r ? g ? console.warn("%c[svelte] svelte_boundary_reset_noop\n%cA `<svelte:boundary>` `reset` function only resets the boundary the first time it is called\nhttps://svelte.dev/e/svelte_boundary_reset_noop", Le, Re) : console.warn("https://svelte.dev/e/svelte_boundary_reset_noop") : (r = !0, i && function() {
				if (g) {
					let e = /* @__PURE__ */ Error("svelte_boundary_reset_onerror\nA `<svelte:boundary>` `reset` function cannot be called while an error is still being handled\nhttps://svelte.dev/e/svelte_boundary_reset_onerror");
					throw e.name = "Svelte error", e;
				}
				throw Error("https://svelte.dev/e/svelte_boundary_reset_onerror");
			}(), this.#s !== null && Rn(this.#s, () => {
				this.#s = null;
			}), this.#x(() => {
				this.#y();
			}));
...
function It(e, t, n, r) {
	...
	if (n.length !== 0 || a.length !== 0) {
		...
		}(), c = a.length === 1 ? a[0].promise : a.length > 1 ? Promise.all(a.map((e) => e.promise)) : null, l = Rt();
		n.length === 0 ? c.then(() => u(t.map(i))).finally(l) : c ? c.then(() => {
			s(), d(), Lt();
		}) : d();
	} else r(t.map(i));
	function u(e) {
	...
	function d() {
		Promise.all(n.map((e) => function(e, t, n) {
			let r = F;
			r === null && function() {
				if (g) {
			...
			return (function(e) {
				...
				i = c.promise;
				try {
					Promise.resolve(e()).then(c.resolve, (e) => {
						e !== Fe && c.reject(e);
					}).finally(Lt);
				} catch (e) {
					c.reject(e), Lt();
				...
				let d = (e, r = void 0) => {
					g && (zt = null), u?.(), s.delete(c), r !== Ut && (l.activate(), r ? (a.f |= Ee, on(a, r)) : ((a.f & Ee) !== 0 && (a.f ^= Ee), on(a, e), g && n !== void 0 && (Vt.add(a), setTimeout(() => {
						Vt.has(a) && (t.f & _e) === 0 && (function(e, t) {
							g ? console.warn(`%c[svelte] await_waterfall\n%cAn async derived, \`${e}\` (${t}) was not read immediately after it resolved. This often indicates an unnecessary waterfall, which can slow down your app\nhttps://svelte.dev/e/await_waterfall`, Le, Re) : console.warn("https://svelte.dev/e/await_waterfall");
						}(a.label, n), Vt.delete(a));
					}))), l.deactivate());
				};
				c.promise.then(d, (e) => d(null, e || "unknown"));
			}), Dn(() => {
				for (let e of s) e.reject(Ut);
			}), g && (a.f |= Te), new Promise((e) => {
				function t(n) {
					function r() {
						n === i ? e(a) : t(i);
					}
		...
		}(e))).then((e) => u([...t.map(i), ...e])).catch((e) => E(e, o)).finally(l);
	}
}
function Lt(e = !0) {
...
function Rt() {
	var e = F, t = e.b, n = D, r = t.is_rendered();
...
function qt(e) {
	...
	if (!N && r !== null && 24576 & r.f) return g ? console.warn("%c[svelte] derived_inert\n%cReading a derived belonging to a now-destroyed effect may result in stale values\nhttps://svelte.dev/e/derived_inert", Le, Re) : console.warn("https://svelte.dev/e/derived_inert"), e.v;
	if (qn(r), g) {
		let r = Xt;
		Qt(/* @__PURE__ */ new Set());
		try {
			y.call(Kt, e) && function() {
				if (g) {
					let e = /* @__PURE__ */ Error("derived_references_self\nA derived value cannot reference itself recursively\nhttps://svelte.dev/e/derived_references_self");
					throw e.name = "Svelte error", e;
				}
				throw Error("https://svelte.dev/e/derived_references_self");
			}(), Kt.push(e), e.f &= -65537, Gt(e), t = ar(e);
		} finally {
			qn(n), Qt(r), Kt.pop();
		}
	} else try {
...
function Jt(e) {
	var t = qt(e);
	e.equals(t) || (e.wv = nr(), D?.is_fork && e.deps !== null || (D === null ? e.v = t : (D.capture(e, t, !0), yt?.capture(e, t, !0)), e.deps !== null)) ? N || (bt === null ? mt(e) : (En() || D?.is_fork) && bt.set(e, t)) : pt(e, pe);
}
function Yt(e) {
	if (e.effects !== null) for (let t of e.effects) t.teardown && cr(t);
}
var Xt = /* @__PURE__ */ new Set(), Zt = /* @__PURE__ */ new Map();
function Qt(e) {
	Xt = e;
}
var $t = !1;
...
function rn(e, t) {
	return an(e, dr(() => I(e))), t;
}
function an(e, t, n = !1) {
	P === null || Gn && (P.f & xe) === 0 || !it() || !(4325394 & P.f) || Jn !== null && y.call(Jn, e) || function() {
		if (g) {
...
function on(e, t, n = null) {
	if (!e.equals(t)) {
		...
		e.wv = nr(), ln(e, me, n), !it() || F === null || (F.f & pe) === 0 || 96 & F.f || (Zn === null ? function(e) {
			Zn = e;
		}([e]) : Zn.push(e)), !r.is_fork && Xt.size > 0 && !$t && sn();
	}
	return t;
}
function sn() {
...
function dn(e) {
	...
	var n = /* @__PURE__ */ new Map(), r = _(e), i = tn(0), a = er, o = (e) => {
		if (er === a) return e();
		var t = P, n = er;
		Kn(null), tr(a);
		var r = e();
	...
	r && (n.set("length", tn(e.length)), g && (e = new Proxy(e, { get(e, t, n) {
		var r = Reflect.get(e, t, n);
		return mn.has(t) ? function(...e) {
			$t = !0;
	...
	return new Proxy(e, {
		...
		get(t, r, i) {
			if (r === De) return e;
			if (g && r === ke) return l;
			var a = n.get(r), c = r in t;
			if (a !== void 0 || c && !C(t, r)?.writable || (a = o(() => {
				var e = tn(dn(c ? t[r] : p));
		...
		has(e, t) {
			if (t === De) return !0;
			var r = n.get(t), i = r !== void 0 && r.v !== p || Reflect.has(e, t);
			return (r !== void 0 || F !== null && (!i || C(e, t)?.writable)) && (r === void 0 && (r = o(() => {
				var n = tn(i ? dn(e[t]) : p);
		...
		set(e, t, a, c) {
			...
			if (r && t === "length") for (var d = a; d < l.v; d += 1) {
				var f = n.get(d + "");
				f === void 0 ? d in e && (f = o(() => tn(p)), n.set(d + "", f), g && Je(f, fn(s, d))) : an(f, p);
			}
			l === void 0 ? u && !C(e, t)?.writable || (l = o(() => tn(void 0)), g && Je(l, fn(s, t)), an(l, dn(a)), n.set(t, l)) : (u = l.v !== p, an(l, o(() => dn(a))));
			var m = Reflect.getOwnPropertyDescriptor(e, t);
			if (m?.set && m.set.call(c, a), !u) {
				if (r && typeof t == "string") {
					var h = n.get("length"), _ = Number(t);
...
function fn(e, t) {
	return typeof t == "symbol" ? `${e}[Symbol(${t.description ?? ""})]` : un.test(t) ? `${e}.${t}` : /^\d+$/.test(t) ? `${e}[${t}]` : `${e}['${t}']`;
}
function pn(e) {
	try {
...
function _n() {
	if (hn === void 0) {
		...
		M = C(t, "firstChild").get, gn = C(t, "nextSibling").get, ie(e) && (e[je] = void 0, e[Ae] = null, e[Me] = void 0, e.__e = void 0), ie(n) && (n[Ne] = void 0), g && (e.__svelte_meta = null, function() {
			...
			e.indexOf = function(e, t) {
				...
				if (r === -1) {
					for (let n = t ?? 0; n < this.length; n += 1) if (pn(this[n]) === e) {
						Be("array.indexOf(...)");
						break;
					}
				}
				...
				if (n === -1) {
					for (let n = 0; n <= (t ?? this.length - 1); n += 1) if (pn(this[n]) === e) {
				...
				if (!n) {
					for (let t = 0; t < this.length; t += 1) if (pn(this[t]) === e) {
						Be("array.includes(...)");
						break;
					}
				}
...
function Tn(e, t) {
	...
	if (4 & e) wt === null ? O.ensure().schedule(r) : wt.push(r);
		...
		i.deps === null && i.teardown === null && i.nodes === null && i.first === i.last && (i.f & Se) === 0 && (i = i.first, (e & le) !== 0 && (e & be) !== 0 && i !== null && (i.f |= be));
	}
	if (i !== null && (i.parent = n, n !== null && function(e, t) {
		var n = t.last;
		n === null ? t.last = t.first = e : (n.next = e, e.prev = n, t.last = e);
	}(i, n), P !== null && 2 & P.f && (e & de) === 0)) {
		var a = P;
		(a.effects ??= []).push(i);
	}
	return r;
...
function In(e, t = !0) {
	var n = !1;
	(t || 262144 & e.f) && e.nodes !== null && e.nodes.end !== null && (function(e, t) {
		for (; e !== null;) {
			var n = e === t ? null : bn(e);
			e.remove(), e = n;
		}
	}(e.nodes.start, e.nodes.end), n = !0), pt(e, ye), Fn(e, t && !n), sr(e, 0);
	var r = e.nodes && e.nodes.t;
	if (r !== null) for (let e of r) e.stop();
	Pn(e), e.f ^= ye, e.f |= _e;
	var i = e.parent;
	i !== null && i.first !== null && Ln(e), g && (e.component_function = null), e.next = e.prev = e.teardown = e.ctx = e.deps = e.fn = e.nodes = e.ac = e.b = null;
}
function Ln(e) {
...
var Jn = null, Yn = null, Xn = 0, Zn = null, Qn = 1, $n = 0, er = $n;
function tr(e) {
	er = e;
}
function nr() {
...
function ir(e, t, n = !0) {
	var r = e.reactions;
	if (r !== null && (Jn === null || !y.call(Jn, e))) for (var i = 0; i < r.length; i++) {
		var a = r[i];
		2 & a.f ? ir(a, t, !1) : t === a && (n ? pt(a, me) : (a.f & pe) !== 0 && pt(a, he), Nt(a));
	}
}
function ar(e) {
	var t = Yn, n = Xn, r = Zn, i = P, a = Jn, o = T, s = Gn, c = er, l = e.f;
	Yn = null, Xn = 0, Zn = null, P = 96 & l ? null : e, Jn = null, Ze(e.ctx), Gn = !1, er = ++$n, e.ac !== null && (Cn(() => {
		e.ac.abort(Fe);
	}), e.ac = null);
	try {
		e.f |= we;
		var u = (0, e.fn)();
		e.f |= ve;
		var d = e.deps, f = D?.is_fork;
		if (Yn !== null) {
			var p;
			if (f || sr(e, Xn), d !== null && Xn > 0) for (d.length = Xn + Yn.length, p = 0; p < Yn.length; p++) d[Xn + p] = Yn[p];
			else e.deps = d = Yn;
...
function or(e, t) {
	...
	if (n === null && 2 & t.f && (Yn === null || !y.call(Yn, t))) {
		var a = t;
		(a.f & fe) !== 0 && (a.f ^= fe, a.f &= -65537), a.v !== p && mt(a), function(e) {
			if (e.effects !== null) for (let t of e.effects) (t.teardown || t.ac) && (t.teardown?.(), t.ac?.abort(Fe), t.teardown = ae, t.ac = null, sr(t, 0), Fn(t));
		}(a), sr(a, 0);
	}
}
function sr(e, t) {
...
function I(e) {
	...
	if (P !== null && !Gn && !(F !== null && (F.f & _e) !== 0 || Jn !== null && y.call(Jn, e))) {
		var r = P.deps;
		if ((P.f & we) !== 0) e.rv < $n && (e.rv = $n, Yn === null && r !== null && r[Xn] === e ? Xn++ : Yn === null ? Yn = [e] : Yn.push(e));
		else {
			(P.deps ??= []).push(e);
			var i = e.reactions;
	...
	if (g) {
		if (!Gn && zt && !zt.warned && (zt.effect.f & we) === 0 && !zt.effect_deps.has(e)) {
			zt.warned = !0, t = e.label, g ? console.warn(`%c[svelte] await_reactivity_loss\n%cDetected reactivity loss when reading \`${t}\`. This happens when state is read in an async function after an earlier \`await\`\nhttps://svelte.dev/e/await_reactivity_loss`, Le, Re) : console.warn("https://svelte.dev/e/await_reactivity_loss");
			var a = Xe("traced at");
			a && console.warn(a);
		}
		Vt.delete(e);
	...
	if (n) {
		...
		var c = (o.f & fe) === 0 && !Gn && P !== null && (Un || (P.f & fe) !== 0), l = (o.f & ve) === 0;
...
function lr(e) {
	if (e.f |= fe, e.deps !== null) for (let t of e.deps) (t.reactions ??= []).push(e), 2 & t.f && (t.f & fe) === 0 && (Yt(t), lr(t));
}
function ur(e) {
	if (e.v === p) return !0;
...
var mr = Symbol("events"), hr = /* @__PURE__ */ new Set(), gr = /* @__PURE__ */ new Set(), _r = null;
function vr(e) {
...
var yr = globalThis?.window?.trustedTypes && globalThis.window.trustedTypes.createPolicy("svelte-trusted-html", { createHTML: (e) => e });
function br(e) {
	var t = xn("template");
...
function Sr(e, t) {
	var n, r = !!(1 & t), i = !!(2 & t), a = !e.startsWith("<!>");
	return () => {
...
function Dr(e, t) {
	...
	try {
		...
		return r !== f && console.warn("Failed to hydrate: ", r), !1 === t.recover && function() {
			if (g) {
				let e = /* @__PURE__ */ Error("hydration_failed\nFailed to hydrate the application\nhttps://svelte.dev/e/hydration_failed");
				throw e.name = "Svelte error", e;
			}
			throw Error("https://svelte.dev/e/hydration_failed");
		}(), _n(), n.textContent = "", He(!1), Er(e, t);
	} finally {
		He(r), Ue(i);
	}
}
...
function kr(e, { target: t, anchor: n, props: r = {}, events: i, context: a, intro: o = !0, transformError: s }) {
	...
	var c = void 0, l = function(e) {
		...
		(function(e, t, n, r) {
			...
			if (nt({}), a && (T.c = a), i && (r.$$events = i), Ve && xr(t, null), c = e(t, r) || {}, Ve && (F.nodes.end = w, w === null || w.nodeType !== 8 || w.data !== "]")) throw ze(), f;
			rt();
		}, s);
...
function jr(e, t) {
	let n = Ar.get(e);
	return n ? (Ar.delete(e), n(t)) : (g && (De in e ? g ? console.warn("%c[svelte] state_proxy_unmount\n%cTried to unmount a state proxy, rather than a component\nhttps://svelte.dev/e/state_proxy_unmount", Le, Re) : console.warn("https://svelte.dev/e/state_proxy_unmount") : g ? console.warn("%c[svelte] lifecycle_double_unmount\n%cTried to unmount a component that was not mounted\nhttps://svelte.dev/e/lifecycle_double_unmount", Le, Re) : console.warn("https://svelte.dev/e/lifecycle_double_unmount")), Promise.resolve());
}
var Mr = class {
	anchor;
	#e = /* @__PURE__ */ new Map();
	...
	#a = (e) => {
		if (this.#e.has(e)) {
			...
			if (n) Bn(n), this.#r.delete(t);
				...
				var r = this.#n.get(t);
				r && (this.#t.set(t, r.effect), this.#n.delete(t), g && (r.fragment.lastChild[Pe] = this.anchor), r.fragment.lastChild.remove(), this.anchor.before(r.fragment), n = r.effect);
			}
			...
			for (let [e, r] of this.#t) {
				...
				let i = () => {
					if (Array.from(this.#e.values()).includes(e)) {
						...
						Hn(r, t), t.append(vn()), this.#n.set(e, {
							effect: r,
							fragment: t
						});
					} else In(r);
		...
		var n = D;
		!t || this.#t.has(e) || this.#n.has(e) || this.#t.set(e, Nn(() => t(this.anchor))), this.#e.set(n, e), Ve && (this.anchor = w), this.#a(n);
	}
};
if (g) {
	function e(e) {
...
function Nr(e) {
	var t, n;
	T === null && Ie("onMount"), d && T.l !== null ? (t = T, n = t.l, n.u ??= {
		a: [],
		b: [],
		m: []
	}).m.push(e) : On(() => {
...
function Ir(e, t) {
	An(() => {
		...
		if (!r.querySelector("#" + t.hash)) {
			let e = xn("style");
			e.id = t.hash, e.textContent = t.code, r.appendChild(e), g && function(e, t) {
				var n = Pr.get(e);
...
function Rr(e) {
	return typeof e == "object" ? function() {
		for (var e, t, n = 0, r = "", i = arguments.length; n < i; n++) (e = arguments[n]) && (t = Lr(e)) && (r && (r += " "), r += t);
		return r;
	}(e) : e ?? "";
}
var zr = [..." 	\n\r\f\xA0\v﻿"];
		...
		var s = function(e, t, n) {
			...
			if (t && (r = r ? r + " " + t : t), n) {
				for (var i of Object.keys(n)) if (n[i]) r = r ? r + " " + i : i;
					...
					var s = o + a;
					o !== 0 && !zr.includes(r[o - 1]) || s !== r.length && !zr.includes(r[s]) ? o = s : r = (o === 0 ? "" : r.substring(0, o)) + r.substring(s + 1);
				}
			}
			return r === "" ? null : r;
		}(n, r, a);
		Ve && s === e.getAttribute("class") || (s == null ? e.removeAttribute("class") : t ? e.className = s : e.setAttribute("class", s)), e[je] = n;
...
function Ur(e = !1) {
	...
	n.b.length && (i = () => {
		R(t, r), se(n.b);
	}, wn("$effect.pre"), g && S(i, "name", { value: "$effect.pre" }), Tn(1048584, i)), On(() => {
		let e = dr(() => n.m.map(oe));
		return () => {
...
function z(e, t, n, r) {
	var i = !d || !!(2 & n), a = !!(8 & n), o = !!(16 & n), s = r, c = !0, l = void 0, u = () => o && i ? (l ??= Ht(r), I(l)) : (c && (c = !1, s = o ? dr(r) : r), s);
	let f;
	if (a) {
	...
	}(() => e[t]) : m = e[t], m === void 0 && r !== void 0 && (m = u(), f && (i && function(e) {
		if (g) {
			let t = /* @__PURE__ */ Error(`props_invalid_value\nCannot do \`bind:${e}={undefined}\` when \`${e}\` has a fallback value\nhttps://svelte.dev/e/props_invalid_value`);
			throw t.name = "Svelte error", t;
		}
...
var Wr = class {
	...
	constructor(e) {
		...
		}), e?.props?.$$host && !1 !== e.sync || k(), this.#e = r.$$events;
...
typeof HTMLElement == "function" && (Gr = class extends HTMLElement {
	...
	async connectedCallback() {
		if (this.$$cn = !0, !this.$$c) {
			...
			for (let e of this.$$s) e in r && (e !== "default" || this.$$d.children ? n[e] = t(e) : (this.$$d.children = t(e), n.default = !0));
	...
	$$g_p(e) {
		return x(this.$$p_d).find((t) => this.$$p_d[t].attribute === e || !this.$$p_d[t].attribute && t.toLowerCase() === e) || e;
	}
}), function(e) {
	e.CUSTOM_MESSAGE = "custom", e.GET_CONTEXT = "luigi.get-context", e.SEND_CONTEXT_HANDSHAKE = "luigi.init", e.CONTEXT_RECEIVED = "luigi.init.ok", e.NAVIGATION_REQUEST = "luigi.navigation.open", e.ALERT_REQUEST = "luigi.ux.alert.show", e.ALERT_CLOSED = "luigi.ux.alert.hide", e.INITIALIZED = "luigi.init.ok", e.ADD_SEARCH_PARAMS_REQUEST = "luigi.addSearchParams", e.ADD_NODE_PARAMS_REQUEST = "luigi.addNodeParams", e.SHOW_CONFIRMATION_MODAL_REQUEST = "luigi.ux.confirmationModal.show", e.CONFIRMATION_MODAL_CLOSED = "luigi.ux.confirmationModal.hide", e.SHOW_LOADING_INDICATOR_REQUEST = "luigi.show-loading-indicator", e.HIDE_LOADING_INDICATOR_REQUEST = "luigi.hide-loading-indicator", e.SET_CURRENT_LOCALE_REQUEST = "luigi.ux.set-current-locale", e.LOCAL_STORAGE_SET_REQUEST = "storage", e.RUNTIME_ERROR_HANDLING_REQUEST = "luigi-runtime-error-handling", e.SET_ANCHOR_LINK_REQUEST = "luigi.setAnchor", e.SET_THIRD_PARTY_COOKIES_REQUEST = "luigi.third-party-cookie", e.BACK_NAVIGATION_REQUEST = "luigi.navigation.back", e.GET_CURRENT_ROUTE_REQUEST = "luigi.navigation.currentRoute", e.SEND_CURRENT_ROUTE_ANSWER = "luigi.navigation.currentRoute.answer", e.SEND_CONTEXT_OBJECT = "luigi.navigate", e.NAVIGATION_COMPLETED_REPORT = "luigi.navigate.ok", e.CLOSE_MODAL_ANSWER = "luigi.navigation.modal.close", e.UPDATE_MODAL_PATH_DATA_REQUEST = "luigi.navigation.updateModalDataPath", e.UPDATE_MODAL_SETTINGS = "luigi.navigation.updateModalSettings", e.CHECK_PATH_EXISTS_REQUEST = "luigi.navigation.pathExists", e.SEND_PATH_EXISTS_ANSWER = "luigi.navigation.pathExists.answer", e.SET_DIRTY_STATUS_REQUEST = "luigi.set-page-dirty", e.AUTH_SET_TOKEN = "luigi.auth.tokenIssued", e.ADD_BACKDROP_REQUEST = "luigi.add-backdrop", e.REMOVE_BACKDROP_REQUEST = "luigi.remove-backdrop", e.SET_VIEW_GROUP_DATA_REQUEST = "luigi.setVGData", e.CLOSE_CURRENT_MODAL_REQUEST = "luigi.close-modal";
}(B ||= {});
var Jr = class extends Event {
	...
	sendCustomMessageToIframe(e, t, n) {
		...
		if (e?.iframe?.contentWindow) {
			...
			r === "custom" ? e.iframe.contentWindow.postMessage({
				msg: r,
				data: t
			}, n.origin) : e.iframe.contentWindow.postMessage({
				msg: r,
				...t
			}, n.origin);
	...
	getContainerManager() {
		return globalThis.__luigi_container_manager || (globalThis.__luigi_container_manager = {
			container: [],
			messageListener: (e) => {
				let t = this.getTargetContainer(e), n = t?.iframeHandle?.iframe?.contentWindow;
				if (n && n === e.source) switch (e.data.msg) {
					case B.CUSTOM_MESSAGE:
						{
							let n = e.data.data, r = n.id;
							delete n.id, this.dispatch(V.CUSTOM_MESSAGE, t, {
								id: r,
								_metaData: {},
								data: n
							});
					...
					case B.SHOW_CONFIRMATION_MODAL_REQUEST:
						this.dispatchWithPayload(V.SHOW_CONFIRMATION_MODAL_REQUEST, t, e.data.data, e.data.data?.settings, (e) => {
					...
					case B.REMOVE_BACKDROP_REQUEST:
						...
						break;
					case B.CLOSE_CURRENT_MODAL_REQUEST: this.dispatch(V.CLOSE_CURRENT_MODAL_REQUEST, t, e);
				}
			}
...
}, Xr = new Yr(), Zr = new class {
	constructor() {
		this.updateContext = (e, t, n, r, i, a) => {
			if (n) {
				let o = t || {};
				Xr.sendCustomMessageToIframe(n, {
					context: e,
					nodeParams: r || {},
					pathParams: i || {},
					searchParams: a || {},
			...
			if (r) {
				let i = n || {};
				Xr.sendCustomMessageToIframe(r, {
					context: t,
					internal: i,
					withoutSync: !1,
					viewUrl: e
			...
			e && t ? Xr.sendCustomMessageToIframe(e, { authData: t }, B.AUTH_SET_TOKEN) : console.warn("Attempting to update auth data on inexisting iframe or authData");
		}, this.sendCustomMessage = (e, t, n, r, i) => {
			if (n && t._luigi_mfe_webcomponent) Xr.dispatch(e, t._luigi_mfe_webcomponent, i);
			else {
				let t = { ...i };
				t.id && console.warn("Property \"id\" is reserved and can not be used in custom message data"), t.id = e, Xr.sendCustomMessageToIframe(r, t);
			}
	...
	constructor(e) {
		super(e || { use: {} }), e && e.use && e.use.extends && (this.superRenderer = ti({
			use: e.use.extends,
			config: e.config
		}));
	}
	...
	createCompoundContainer() {
		let e = "__lui_compound_" + (/* @__PURE__ */ new Date()).getTime(), t = document.createElement("div");
		t.classList.add(e);
		let n = "";
		return this.config.layouts && this.config.layouts.forEach((t) => {
			if (t.minWidth || t.maxWidth) {
				let r = "@media only screen ";
				t.minWidth != null && (r += `and (min-width: ${t.minWidth}px) `), t.maxWidth != null && (r += `and (max-width: ${t.maxWidth}px) `), r += `{\n            .${e} {\n              grid-template-columns: ${t.columns || "auto"};\n              grid-template-rows: ${t.rows || "auto"};\n              grid-gap: ${t.gap || "0"};\n            }\n          }\n          `, n += r;
			}
	...
	createCompoundItemContainer(e) {
		...
		return n.setAttribute("style", `grid-row: ${t.row || "auto"}; grid-column: ${t.column || "auto"}`), n.classList.add("lui-compoundItemCnt"), n;
	}
}, ti = (e) => {
	let t = e.use;
	return t ? t === "grid" ? new ei(e) : t.createCompoundContainer || t.createCompoundItemContainer || t.attachCompoundItem ? new $r(e) : new Qr(e) : new Qr(e);
}, ni = (e, t, n, r) => {
	t?.eventListeners && t.eventListeners.forEach((t) => {
		let i = t.source + "." + t.name, a = e[i], o = {
			wcElementId: n,
			wcElement: r,
			action: t.action,
...
var ii = class {
	...
	attachWC(e, t, n, r, i, a, o) {
		if (n && n.contains(t)) {
			...
			a && s.setAttribute("nodeId", a), s.setAttribute("lui_web_component", "true"), this.initWC(s, e, n, i, r, a, o), n.replaceChild(s, t), n._luigi_node && (n._luigi_mfe_webcomponent = s), n.dispatchEvent(new Event("wc_ready"));
		}
	}
	...
	createClientAPI(e, t, n, r, i) {
		return {
			linkManager: () => {
				let e = null, t = !1, n = !1, r = !1, i = {}, a = {
					navigate: (a, o = {}, s) => {
						...
						this.dispatchLuigiEvent(V.NAVIGATION_REQUEST, {
							link: a,
							...c
						}, s);
					},
					...
					updateModalPathInternalNavigation: (a, o = {}, s = !1) => {
						if (!a) return void console.warn("Updating path of the modal upon internal navigation prevented. No path specified.");
						let c = {
							fromClosestContext: t,
							fromContext: e,
							fromParent: r,
						...
						this.dispatchLuigiEvent(V.UPDATE_MODAL_PATH_DATA_REQUEST, Object.assign(c, {
							history: s,
							link: a,
							modal: o
						}));
					...
					pathExists: (a) => {
						...
						return new Promise((e, t) => {
							this.containerService.dispatch(V.CHECK_PATH_EXISTS_REQUEST, this.thisComponent, {
								...o,
								link: a
							}, (n) => {
								n ? e(!0) : t(!1);
							}), this.containerService.dispatch(V.PATH_EXISTS_REQUEST, this.thisComponent, {
								...o,
								link: a
							}, (n) => {
								n ? e(!0) : t(!1);
					...
					openAsModal: (e, t = {}, n) => new Promise((r) => {
			...
			uxManager: () => ({
				showAlert: (e) => (e.id = this.alertIndex++, new Promise((t) => {
					this.alertResolvers[e.id] = t, this.dispatchLuigiEvent(V.ALERT_REQUEST, e, (t) => {
						this.resolveAlert(e.id, t);
					});
				})),
				showConfirmationModal: (e) => new Promise((t, n) => {
					this.modalResolver = {
						resolve: t,
						reject: n
			...
			addNodeParams: (e, t) => {
				i || this.dispatchLuigiEvent(V.ADD_NODE_PARAMS_REQUEST, {
					params: e,
					data: e,
			...
			getNodeParams: (e) => {
				return i ? {} : e ? (t = this.thisComponent.nodeParams, Object.entries(t).reduce((e, t) => (e[ri(t[0])] = ri(t[1]), e), {})) : this.thisComponent.nodeParams || {};
				var t;
			},
			setAnchor: (e) => {
	...
	initWC(e, t, n, r, i, a, o) {
		...
		if (e.__postProcess) {
			let t = new URL(document.baseURI).origin === new URL(r, document.baseURI).origin ? new URL("./", new URL(r, document.baseURI)) : new URL("./", r);
	...
	generateWCId(e) {
		let t = "", n = new URL(e, encodeURI(location.href)).href;
	...
	includeSelfRegisteredWCFromUrl(e, t, n) {
		if (this.checkWCUrl(t)) {
			...
			}), window.Luigi || (window.Luigi = {}, window.Luigi._registerWebcomponent || (window.Luigi._registerWebcomponent = (e, t) => {
				this.containerService.getContainerManager()._registerWebcomponent(e, t);
			}));
			let r = document.createElement("script");
			r.setAttribute("src", t), e.webcomponent.type === "module" && r.setAttribute("type", "module"), r.setAttribute("defer", "true"), r.addEventListener("load", () => {
				n();
	...
	renderWebComponent(e, t, n, r, i, a) {
		let o = this.processViewUrl(e, { context: n }), s = r?.webcomponent?.tagName || this.generateWCId(o), c = document.createElement("div");
		t.appendChild(c), t._luigi_node = r, window.customElements.get(s) ? this.attachWC(s, c, t, n, o, i, a) : window.luigiWCFn ? window.luigiWCFn(o, s, c, () => {
			this.attachWC(s, c, t, n, o, i, a);
		}) : r?.webcomponent?.selfRegistered ? this.includeSelfRegisteredWCFromUrl(r, o, () => {
			this.attachWC(s, c, t, n, o, i, a);
		}) : this.registerWCFromUrl(o, s).then(() => {
			this.attachWC(s, c, t, n, o, i, a);
		}).catch((e) => {
			console.warn("ERROR =>", e), this.containerService.dispatch(V.RUNTIME_ERROR_HANDLING_REQUEST, this.thisComponent, e);
		});
	}
	createCompoundContainerAsync(e, t, n) {
		return new Promise((r, i) => {
			if (e.viewUrl) try {
				...
				n?.webcomponent?.selfRegistered ? this.includeSelfRegisteredWCFromUrl(n, e.viewUrl, () => {
					let n = document.createElement(i);
					n.setAttribute("lui_web_component", "true"), this.initWC(n, i, n, e.viewUrl, t, "_root"), r(n);
				}) : this.registerWCFromUrl(e.viewUrl, i).then(() => {
					let n = document.createElement(i);
					n.setAttribute("lui_web_component", "true"), this.initWC(n, i, n, e.viewUrl, t, "_root"), r(n);
				}).catch((e) => {
					console.warn("Error: ", e), this.containerService.dispatch(V.RUNTIME_ERROR_HANDLING_REQUEST, this.thisComponent, e);
	...
	renderWebComponentCompound(e, t, n) {
		let r;
		return e.webcomponent && e.viewUrl ? (r = new Qr(), r.viewUrl = this.processViewUrl(e.viewUrl, { context: n }), r.createCompoundItemContainer = (e) => {
			let t = document.createElement("div");
			return e?.slot && t.setAttribute("slot", e.slot), t;
		}) : e.compound?.renderer && (r = ti(e.compound.renderer)), r ||= new Qr(), new Promise((i) => {
			this.createCompoundContainerAsync(r, n, e).then((a) => {
				...
				a.eventBus = {
					...
					onPublishEvent: (e, t, n) => {
						let r = o[t + "." + e.type] || [];
						r.push(...o["*." + e.type] || []), r.forEach((t) => {
							let n = t.wcElement || a.querySelector("[nodeId=" + t.wcElementId + "]");
							n ? n.dispatchEvent(new CustomEvent(t.action, { detail: t.converter ? t.converter(e.detail) : e.detail })) : console.debug("Could not find event target", t);
						});
					}
				...
				}), t.appendChild(a), ni(o, e.compound, "_root", a), i(a);
			}).catch((e) => {
				console.warn("Error: ", e), this.containerService.dispatch(V.RUNTIME_ERROR_HANDLING_REQUEST, this.thisComponent, e);
			});
		});
	...
	resolveAlert(e, t) {
		this.alertResolvers[e] ? (this.alertResolvers[e](t === void 0 || t), this.alertResolvers[e] = void 0) : console.log("Promise is not in the list.");
	}
	notifyConfirmationModalClosed(e) {
		this.modalResolver ? (e ? this.modalResolver.resolve() : this.modalResolver.reject(), this.modalResolver = void 0) : console.log("Modal promise is not listed.");
	}
}, ai = new class {
	isFunction(e) {
	...
	checkWebcomponentValue(e) {
		return typeof e == "string" ? JSON.parse(e) : typeof e == "boolean" || typeof e == "object" ? e : void console.warn("Webcomponent value has a wrong type.");
	}
	resolveContext(e) {
		return e ? typeof e == "string" ? JSON.parse(e) : e : {};
	}
}(), oi = Sr("<style>main.lui-isolated,\n        .lui-isolated iframe {\n          width: 100%;\n          height: 100%;\n          border: none;\n        }\n\n        main.lui-isolated {\n          line-height: 0;\n        }</style>"), si = Sr("<main><!></main>");
function ci(e, t) {
	nt(t, !1);
	let n = z(t, "activeFeatureToggleList", 12), r = z(t, "allowRules", 12), i = z(t, "anchor", 12), a = z(t, "authData", 12), o = z(t, "clientPermissions", 12), s = z(t, "context", 12), c = z(t, "deferInit", 12), l = z(t, "dirtyStatus", 12), u = z(t, "documentTitle", 12), d = z(t, "hasBack", 12), p = z(t, "label", 12), m = z(t, "locale", 12), h = z(t, "noShadow", 12), g = z(t, "nodeParams", 12), _ = z(t, "pathParams", 12), v = z(t, "sandboxRules", 12), y = z(t, "searchParams", 12), b = z(t, "skipCookieCheck", 12), x = z(t, "skipInitCheck", 12), S = z(t, "theme", 12), C = z(t, "userSettings", 12), ee = z(t, "viewurl", 12), te = z(t, "webcomponent", 12), ne = { iframe: void 0 }, re = nn(), ie = nn(!1), ae = nn(), oe = new ii(), se = () => n() && r() && i() && a() && o() && l() && u() && d() && m() && h() && g() && _() && v() && y() && b() && x() && S() && C(), ce = (e) => {
		if (!I(ie)) {
			...
			}, Xr.registerContainer(e), oe.thisComponent = e;
			let t = ai.resolveContext(s());
			if (e.updateViewUrl = (e, t) => {
				e?.length && Zr.updateViewUrl(e, ai.resolveContext(s()), t, ne);
			}, te() && te() != "false") {
				e.getNoShadow() ? e.innerHTML = "" : (rn(re, I(re).innerHTML = ""), e.attachShadow({ mode: "open" }).append(I(re))), x() || (e.getNoShadow() ? e : I(re)).addEventListener("wc_ready", () => {
					(e.getNoShadow() ? e : I(re))._luigi_mfe_webcomponent?.deferLuigiClientWCInit || (e.initialized = !0, oe.dispatchLuigiEvent(V.INITIALIZED, {}));
				});
			...
			x() && (e.initialized = !0, setTimeout(() => {
				oe.dispatchLuigiEvent(V.INITIALIZED, {});
			})), te() && te() !== "false" || setTimeout(() => {
				ue();
			}), e.containerInitialized = !0, an(ie, !0);
		}
	};
	var le;
	function ue() {
	...
	Nr(async () => {
		an(ae, I(re).parentNode), rn(ae, I(ae).iframeHandle = ne), rn(ae, I(ae).init = () => {
			ce(I(ae));
		}), !c() && ee() && ce(I(ae));
	}), le = async () => {}, T === null && Ie("onDestroy"), Nr(() => () => dr(le)), function(e, t) {
		var n = {
			effect: null,
			ran: !1,
			deps: e
		};
		T.l.$.push(n), n.effect = jn(() => {
			if (e(), !n.ran) {
				n.ran = !0;
				var r = F;
				try {
	...
	}(fe), Hr(fe, (e) => an(re, e), () => I(re)), function(e, t = [], n = [], r = []) {
		It(r, t, n, (t) => {
			Tn(8, () => e(...t.map(I)));
		});
	}(() => Br(fe, 1, Rr(te() ? void 0 : "lui-isolated"))), Cr(e, fe), L(t, "unwarn", se), rt(de);
}
qr(ci, {
	...
	let t = (e) => () => console.warn(e + " can't be called on luigi-container before its micro frontend is attached to the DOM.");
	return class extends e {
		...
		attributeChangedCallback(e, t, n) {
			...
			this.containerInitialized && (e === "context" && this.updateContext(JSON.parse(n)), e === "auth-data" && Zr.updateAuthData(this.iframeHandle, JSON.parse(n)));
		}
		getNoShadow() {
...
var li = Sr("<main class=\"svelte-1yfh4yd\"></main>"), ui = {
	hash: "svelte-1yfh4yd",
	code: "main.svelte-1yfh4yd {width:100%;height:100%;border:none;}"
};
function di(e, t) {
	nt(t, !1), Ir(e, ui);
	let n, r = z(t, "activeFeatureToggleList", 12), i = z(t, "anchor", 12), a = z(t, "clientPermissions", 12), o = z(t, "compoundConfig", 12), s = z(t, "context", 12), c = z(t, "deferInit", 12), l = z(t, "dirtyStatus", 12), u = z(t, "documentTitle", 12), d = z(t, "hasBack", 12), f = z(t, "locale", 12), p = z(t, "noShadow", 12), m = z(t, "nodeParams", 12), h = z(t, "pathParams", 12), g = z(t, "searchParams", 12), _ = z(t, "skipInitCheck", 12), v = z(t, "theme", 12), y = z(t, "userSettings", 12), b = z(t, "viewurl", 12), x = z(t, "webcomponent", 12), S = !1, C = nn(), ee = new Yr(), te = new ii(), ne = () => r() && i() && a() && l() && u() && d() && f() && p() && m() && h() && g() && _() && v() && y(), re = (e) => {
		if (!o() || S) return;
		e.updateContext = (t, n) => {
			let r = e.getNoShadow() ? e : I(C);
			r._luigi_mfe_webcomponent.context = t, s(t);
			let i = r._luigi_mfe_webcomponent;
			i && i.querySelectorAll("[lui_web_component]")?.forEach((e) => {
				let n = e.context || {};
				e.context = Object.assign(n, t);
			});
		};
		let t = ai.resolveContext(s());
		c(!1), e.notifyAlertClosed = (t, n) => {
		...
		e.getNoShadow() ? e.innerHTML = "" : (rn(C, I(C).innerHTML = ""), e.attachShadow({ mode: "open" }).append(I(C))), te.renderWebComponentCompound(r, e.getNoShadow() ? e : I(C), t).then((t) => {
			n = t, _() || !r.viewUrl ? (e.initialized = !0, setTimeout(() => {
				te.dispatchLuigiEvent(V.INITIALIZED, {});
			})) : n.LuigiClient && !n.deferLuigiClientWCInit && (e.initialized = !0, te.dispatchLuigiEvent(V.INITIALIZED, {}));
		}), S = !0, e.containerInitialized = !0;
	};
	Nr(async () => {
		let e = I(C).getRootNode() === document ? I(C).parentNode : I(C).getRootNode().host;
		e.init = () => {
			re(e);
		}, c() || re(e), ee.registerContainer(e), te.thisComponent = e;
	});
	var ie = {
		unwarn: ne,
		get activeFeatureToggleList() {
	...
	Ur();
	var ae = li();
	return Hr(ae, (e) => an(C, e), () => I(C)), Cr(e, ae), L(t, "unwarn", ne), rt(ie);
}
qr(di, {
	activeFeatureToggleList: {
		attribute: "active-feature-toggle-list",
...
}), customElements.get("luigi-container") || customElements.define("luigi-container", ci.element), customElements.get("luigi-compound-container") || customElements.define("luigi-compound-container", di.element);
//#endregion
//#region src/utilities/helpers/escaping-helpers.ts
var fi = {
	sanitizeHtml(e = "") {
		return e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/javascript:/gi, "").replace(/data:/gi, "").replace(/vbscript:/gi, "");
	},
	...
	restoreSanitizedElements(e = "") {
		...
		for (let e = 0; e < n.length; e++) {
			let r = RegExp(`&lt;${n[e]}\/&gt;`, "g"), i = RegExp(`&lt;${n[e]} \/&gt;`, "g"), a = RegExp(`&lt;${n[e]}&gt;`, "g"), o = RegExp(`&lt;${n[e]} &gt;`, "g"), s = RegExp(`&lt;\/${n[e]}[\/]&gt;`, "g"), c = RegExp(`&lt;\/${n[e]} [\/]&gt;`, "g"), l = RegExp(`&lt;[\/]${n[e]}&gt;`, "g"), u = RegExp(`&lt;[\/]${n[e]} &gt;`, "g");
			t = t.replace(r, `<${n[e]}>`).replace(i, `<${n[e]}>`).replace(a, `<${n[e]}>`).replace(o, `<${n[e]}>`).replace(s, `</${n[e]}>`).replace(c, `</${n[e]}>`).replace(l, `</${n[e]}>`).replace(u, `</${n[e]}>`);
		}
		return t;
	},
	...
	processTextAndLinks(e = "", t, n) {
		...
		return t ? Object.entries(t).reduce((e, [t, r]) => {
			let i = `_luigi_alert_${n}_link_${this.sanitizeParam(t)}`, a = `<a id="${i}">${this.restoreSanitizedBrs(this.sanitizeHtml(r.text))}</a>`, o = this.escapeKeyForRegexp(t), s = RegExp(`({${o}})`, "g");
			return {
	...
	checkMatch: (e, t, n) => {
		let r = !0;
		return a.trimTrailingSlash(a.trimLeadingSlash(e)).split("/").forEach((e, i) => {
			r && (i + 1 >= t.length || !t[i + 1]?.pathSegment || !H.segmentMatches(e, t[i + 1]?.pathSegment ?? "", n ?? {})) && (r = !1);
		}), r;
	},
	checkVisibleForFeatureToggles: (e, t) => {
		if (e?.visibleForFeatureToggles) {
			let n = t?.getActiveFeatureToggleList() || [];
			for (let t of e.visibleForFeatureToggles) if (t.startsWith("!")) {
	...
	generateTooltipText: (e, t, n) => {
		...
		switch (r === void 0 && (r = n.getConfigValue("navigation.defaults.tooltipText")), r) {
			...
			case !1: return "";
			default: return n.i18n().getTranslation(r);
		}
	},
	isNodeAccessPermitted: (e, t, n, r) => {
		if (r.auth().isAuthorizationEnabled()) {
			let t = u.isLoggedIn(), n = e.anonymousAccess;
	...
	updateHeaderTitle: (e, t) => {
		...
		if (n && t) {
			let e = "";
			return [...n].sort((e, t) => (t.link || "").localeCompare(e.link || "")).some((n) => {
				let r = !1;
				if (r = H.checkMatch(n.link || "", t.nodesInPath ?? []), !r && n.selectionConditions && n.selectionConditions.route && (r = H.checkMatch(n.selectionConditions.route, t.nodesInPath ?? []), r && (n.selectionConditions.contextCriteria || []).forEach((e) => {
					r &&= (t?.selectedNode)?.context?.[e.key] === e.value;
				})), r) return e = n.title || "", !0;
			}), e;
		}
	},
	buildPath(e, t) {
		return e.map((e) => {
			let n = e.pathSegment;
			if (n?.startsWith(":")) {
				let e = n.slice(1), r = t?.pathParams?.[e];
	...
	async fetchNodeTitleData(e, t) {
		return new Promise((n, r) => {
			...
			delete i._cache;
			let a = this.substituteVars(i, t), o = JSON.stringify(a);
	...
	processTitleData(e, t) {
		...
		return n &&= n.trim(), n && t.titleDecorator && (n = t.titleDecorator.replace("%s", n)), {
	...
	findViewGroup(e, t) {
		if (e.viewGroup) return t && t !== e ? e.viewUrl && t.viewUrl && H.getUrlOrigin(e.viewUrl) === H.getUrlOrigin(t.viewUrl) ? e.viewGroup : void 0 : e.viewGroup;
	...
	addParamsOnHashRouting(e, t, n) {
		let r = t, [i, a] = r.split("?"), o = new URLSearchParams(a);
	...
	filterNodeParams(e, t) {
		let n = Object.create(null), r = this.getContentViewParamPrefix(t);
	...
	mapPathToNode(e, t) {
		if (!e || !t) return;
		let n = a.trimLeadingSlash(e).split("/"), r = U.buildRoute(t, `/${t.pathSegment}`), i = a.trimLeadingSlash(r).split("/");
	...
	resolveNodeLabel(e, t) {
		...
		if (r) {
			let e = (t.getConfigValue("navigation.viewGroupSettings") || {})[r] || {}, i = {
				...e.customData || {},
				...e._liveCustomData || {}
			};
	...
	async getNodeLabel(e, t) {
		...
		if (e.pathSegment && e.pathSegment.indexOf(":") === 0) {
			let n = t.getConfig().routing?.useHashRouting, r = U.mapPathToNode(U.getCurrentPath(t, n)?.path, e) || "", i = await t.navigation().navService.extractDataFromPath(r);
	...
	prepareSearchParamsForClient(e, t) {
		let n = {};
		return e && e.clientPermissions && e.clientPermissions.urlParameters && Object.keys(e.clientPermissions.urlParameters).forEach((r) => {
			r in t.routing().getSearchParams() && e.clientPermissions?.urlParameters && e.clientPermissions.urlParameters[r]?.read === !0 && (n[r] = t.routing().getSearchParams()[r]);
		}), n;
	},
	hasIntent(e) {
	...
	getIntentObject(e) {
		...
		if (t) {
			let e = t.split("?"), n = e[0].split("-"), r = Object.fromEntries(new URLSearchParams(e[1]).entries());
			return {
				semanticObject: n[0],
				action: n[1],
				params: r
	...
	getIntentPath(e, t) {
		...
		if (n && n.length > 0) {
			let r = e.replace(/\?intent=/i, "?intent="), i = this.getIntentObject(r);
			if (i) {
				let e = n.find((e) => e.semanticObject === i.semanticObject && e.action === i.action);
				if (!e) return !1;
				if (e.externalLink) return {
					...e.externalLink,
					external: !0
				};
				e = e.pathSegment;
				...
				if (r && r.length > 0) {
					...
					n ||= "~", e = e.concat(`?${n}`), r.forEach(([t, r], i) => {
						e += `${i > 0 ? "&" + n : ""}${t}=${r}`;
					});
				}
				return e;
	...
	getCurrentPath(e, t, n) {
		if (n && /\?intent=/i.test(location.hash)) {
			let n = location.hash.replace("#/#", "").replace("#", ""), r = U.getIntentPath(n, e);
			if (r) {
				if (typeof r == "string") return e?.getConfigValue("routing.replaceIntentRoute") && history.replaceState(window.state, "", r), {
					path: r,
					query: location.search
				};
				if (a.isObject(r)) return U.handleExternalIntentPath(r), {
	...
	getQueryParams(e) {
		return e.getConfigValue("routing.useHashRouting") ? this.getLocationHashQueryParams() : this.getLocationSearchQueryParams();
	},
	...
	parseParams(e) {
		let t = new URLSearchParams(e), n = /* @__PURE__ */ new Map();
	...
	handleHistoryState(e, t) {
		return e && e.modalHistoryLength ? e.modalHistoryLength += 1 : e = {
	...
	checkWCUrl(e, t) {
		if (e.indexOf("://") > 0 || e.trim().indexOf("//") === 0) {
			...
			if (n?.length > 0) for (let t of n) try {
	...
	setFeatureToggles(e, t, n) {
		let r = this.sanitizeParamsMap(this.parseParams(t.split("?")[1])), i;
	...
	isExistingRoute(e, t) {
		let n = e?.split("/") || [], r = t?.nodesInPath || [], i = (e, t) => {
			let n = null;
	...
	async pathExists(e, t) {
		let n = a.getTrimmedUrl(e), r = await t.navigation().navService.getPathData(e), i = U.isExistingRoute(n, r);
		return r ? i : !1;
	},
	...
	getPageNotFoundRedirectResult(e, t = !1, n) {
		...
		if (typeof r == "function") {
			let n = r(e, t);
			if (n && (n.redirectTo || n.ignoreLuigiErrorHandling)) return {
				path: n.redirectTo,
				keepURL: n.keepURL,
	...
	async handlePageNotFoundAndRetrieveRedirectPath(e, t, n) {
		if (t) return e;
		let r = n.getConfigValue("routing.pageNotFoundHandler"), i = this.getPageNotFoundRedirectResult(e, r, n)?.path;
		if (i !== void 0) return i;
		this.showRouteNotFoundAlert(e, !1, n), console.warn(`Could not find the requested route: ${e}`);
	},
	async getDefaultChildNode(e, t) {
		if (!e) return "";
		let n = e.nodesInPath && e.nodesInPath[e.nodesInPath.length - 1], r = e.context, i = t ? await t(n, r) : await o.getConfigValueFromObjectAsync(n, "children", r), a = i.find((e) => e.pathSegment === n.defaultChildNode);
		if (n.defaultChildNode && a) return n.defaultChildNode;
		if (i && i.length) {
			if (e?.nodesInPath?.length === 1) {
				let e = i.find((e) => e.pathSegment);
				return e && e.pathSegment || console.error("At least one navigation node in the root hierarchy must have a pathSegment.");
			}
	...
	getNodePath(e, t) {
		return !e || t ? e ? this.buildRoute(e, e.pathSegment ? "/" + e.pathSegment : "", t) : "" : `${e.parent ? this.getNodePath(e.parent) : ""}/${e.pathSegment}`;
	},
	buildRoute(e, t, n) {
	...
	substituteViewUrl(e, t, n, r) {
		if (!e.viewUrl) return "";
		let i = e.viewUrl, o = "routing.queryParams";
		if (e.virtualTree && (i = i.replace("{virtualTreePath}", "")), i = a.replaceVars(i, t, ":", !1), e.context && (i = a.replaceVars(i, e.context, "context.")), i = a.replaceVars(i, n, "nodeParams."), i = this.getI18nViewUrl(i, r), i && i.includes(o)) {
			let e = i.split("?")[1];
			if (e) {
				let t = e.split("=")[0], n = r.routing().getSearchParams();
	...
	getI18nViewUrl(e, t) {
		let n = "{i18n.currentLocale}", r = t.i18n().getCurrentLocale();
	...
	concatenatePath(e, t) {
		...
		return n ? !t || typeof t != "string" ? n : (n.endsWith("/") && (n = n.substring(0, n.length - 1)), t.startsWith("/") || (n += "/"), n += t, n) : t;
	},
	getRouteLink(e, t, n) {
		let r = n || "";
	...
	calculateNodeHref(e, t, n) {
		let r = n.getConfigValue("routing.useHashRouting") ? "#" : "", i = U.getRouteLink(e, t, r);
	...
	getPreparedParentNodePath(e) {
		return (!e.parentNodePath || !e.parentNodePath.startsWith("/")) && console.error("Luigi Config Error: navigation.contextSwitcher.parentNodePath must be defined as an absolute path."), e.parentNodePath ? a.addTrailingSlash(e.parentNodePath) : e.parentNodePath;
	},
	...
	getNodePathFromCurrentPath(e, t, n) {
		let r = n.getConfig().routing?.useHashRouting, i = a.addLeadingSlash(U.getCurrentPath(n, r)?.path), o = a.addLeadingSlash(t.link);
	...
	isContextSwitcherDetailsView(e, t) {
		let n = a.normalizePath(e), r = a.normalizePath(t);
		return !!(t && n && typeof n == "string" && n.startsWith(r) && n !== r);
	},
	async getFallbackLabel(e, t, n) {
		if (!e) return t;
		let r = a.getConfigBooleanValue(n.getConfig(), "navigation.contextSwitcher.useFallbackLabelCache"), i = pi._fallbackLabels;
		if (r && i.has(t)) return i.get(t);
		let o = await e(t);
		return r && i.set(t, o), o;
	},
	getSelectedId(e, t, n) {
		if (e = a.normalizePath(e), n = a.normalizePath(n), pi.isContextSwitcherDetailsView(e, n)) return e.replace(n, "").split("/")[0].split("?")[0];
	},
	getSelectedOption(e, t, n) {
		let r = pi.getSelectedId(e, t, n), i;
	...
	handleSearchResultRenderer(e, t, n) {
		...
		let r = {
			...
			fireItemSelected: (t) => {
				e?.onSearchResultItemSelected && typeof e.onSearchResultItemSelected == "function" && e.onSearchResultItemSelected(t);
			}
		};
	...
	unsavedChanges;
	constructor(e) {
		this.luigi = e, this.luigi = e, this.unsavedChanges = {
			isDirty: !1,
			persistUrl: null
		};
	}
	updateDirtyStatus(e, t) {
		...
		this.unsavedChanges.persistUrl = window.location.href, e ? this.unsavedChanges.dirtySet?.add(t) : this.unsavedChanges.dirtySet?.delete(t);
	}
	clearDirtyState(e) {
		this.unsavedChanges && this.unsavedChanges.dirtySet && (e ? this.unsavedChanges.dirtySet.delete(e) : this.unsavedChanges.dirtySet.clear());
	}
	readDirtyStatus() {
	...
	async closeModals() {
		...
		for (let { onInternalClose: t } of e) try {
			typeof t == "function" && t();
		} catch (e) {
	...
	async closeModalsWithDirtyCheck() {
		let e = W.get(gi);
		for (let t of G.modalContainer) if (e.shouldShowUnsavedChangesModal(t)) try {
	...
	async getPathData(e) {
		let t = this.luigi.getConfig(), n = e.split("/");
		n?.length > 0 && n[0] === "" && (n = n.slice(1));
		let r = t.navigation?.globalContext || {}, i;
		if (this.getNodeDataManagementService().hasRootNode()) i = this.getNodeDataManagementService().getRootNode().node;
			...
			typeof e == "object" && !Array.isArray(e) ? (i = e, i.pathSegment && (i.pathSegment = "", console.warn("Root node must have an empty path segment. Provided path segment will be ignored."))) : i = { children: e }, i.children = await this.getChildren(i, r), i.children = this.prepareRootNodes(i.children || [], r), this.getNodeDataManagementService().setRootNode(i);
		}
		let a = {
		...
		if (i.viewUrl && n.length === 0) s.selectedNode = i;
		else for (let e of n) if (s.selectedNodeChildren) {
			...
			let n = t._rawContext ?? {}, i = H.mergeContext(r, n, t.navigationContext), a = i;
			if (t.pathSegment?.startsWith(":") && (o[t.pathSegment.replace(":", "")] = fi.sanitizeParam(e), a = U.substituteDynamicParamsInObject(i, o)), r = a, t.context = a, s.selectedNode = t, s.selectedNode && s.nodesInPath?.push(s.selectedNode), t.virtualTree || t._virtualTree) {
	...
	findMatchingNode(e, t) {
		let n, r = t.filter((e) => !!e.pathSegment).length, i = t.filter((e) => e.pathSegment && e.pathSegment.startsWith(":")).length;
		if (r > 1 && (i === 1 && (console.warn("Invalid node setup detected. \nStatic and dynamic nodes cannot be used together on the same level. Static node gets cleaned up. \nRemove the static node from the configuration to resolve this warning. \nAffected pathSegment:", e, "Children:", t), t = t.filter((e) => e.pathSegment && e.pathSegment.startsWith(":"))), i > 1)) {
	...
	async buildNavItems(e, t, n) {
		let r = {}, i = [], a = [], o = [];
		for (let s of e) {
			if (!H.isNodeAccessPermitted(s, this.getParentNode(n.selectedNode, n), n?.selectedNode?.context || {}, this.luigi)) continue;
			let e = !!s.badgeCounter, c = s.externalLink ? { ...s.externalLink } : void 0, l = U.getNodeHref(s, n?.pathParams, this.luigi), u = 0;
			...
			if (d) {
				let n = s.category.id || s.category.label || s.category, a = this.luigi.i18n().getTranslation(s.category.label || s.category.id || s.category), o = r[n];
				if (!o) o = {
					badgeCounter: e ? {
						count: () => Number(u),
						label: ""
		...
		let s = o?.length ? o.reduce((e, t) => e + t) : 0, c = {
			count: () => s,
			label: ""
		};
		return i.unshift(...a), {
	...
	async getCurrentNode(e) {
		...
		if (!n && t.nodesInPath?.length === 1 && (n = t.nodesInPath[0]), !(!n || !H.isNodeAccessPermitted(n, this.getParentNode(t.selectedNode, t), t?.selectedNode?.context || {}, this.luigi))) return n;
	}
	...
	getTruncatedChildren(e) {
		let t = !1, n = !1, r = [];
		return e.slice().reverse().forEach((e) => {
			(!t || e.tabNav) && (e.tabNav === !1 && (n = !0), e.keepSelectedForChildren === !1 ? t = !0 : (e.keepSelectedForChildren || e.tabNav && !n) && (t = !0, r = [])), r.push(e);
		}), r.reverse();
	}
	applyNavGroups(e) {
		let t = {}, n = [], r = [];
		return e.forEach((e) => {
			...
			n && n.category && (n.category.isGroup || (n.category.isGroup = !0), n.category.nodes || (n.category.nodes = []), n.category.nodes.push(e));
		}), r.filter((e) => {
			if (e.category?.isGroup && e.category?.nodes && e.category?.nodes.length > 0) {
				for (let t = 0; t < e.category?.nodes.length; t++) {
					...
					if (n.node && !n.node.hideFromNav && n.node.label || n.category?.nodes && n.category.nodes.filter((e) => !e.node?.hideFromNav && e.node?.label).length > 0) return !0;
				}
				return !1;
			}
			return !0;
	...
	async getLeftNavData(e, t) {
		...
		let o = this.getTruncatedChildren(n.nodesInPath ?? []), s = [...o].pop(), c = n.selectedNode;
	...
	async navItemClick(e, t) {
		...
		if (await W.get(gi).getUnsavedChangesModalPromise(), e.externalLink?.url) {
			let r = { ...e };
			t?.selectedNode?.context && (r.context = {
				...r.context,
				...t.selectedNode.context
			});
			let i = { ...r.externalLink }, a = {
				...r,
				viewUrl: i.url
			};
		...
		if (r = a.replaceVars(r, n, ":", !1), !r && r !== "") {
			console.error("Navigation error: could not build path for the node. Check if pathSegment is defined for all nodes in the path and if there are no duplicate pathSegments on the same level.");
			return;
		}
		return this.luigi.navigation().navigate(r);
	}
	async getTopNavData(e, t) {
		let n = this.luigi.getConfig(), r = t ?? await this.getPathData(e), i = n.navigation?.profile?.items?.length ? JSON.parse(JSON.stringify(n.navigation.profile.items)) : [], a = n.navigation?.appSwitcher && this.getAppSwitcherData(n.navigation?.appSwitcher, n.settings?.header), o = H.updateHeaderTitle(a, r);
		i?.length && i.forEach((e) => {
			e.label = this.luigi.i18n().getTranslation(e.label || ""), e.children?.length && e.children.forEach((e) => {
				e.label = this.luigi.i18n().getTranslation(e.label || "");
			});
		});
		let s = this.luigi.i18n().getTranslation(n.navigation?.profile?.logout?.label) || hi.logout.label, c = (e) => {
			e.openNodeInModal && !e.externalLink?.url ? this.luigi.navigation().openAsModal(e.link || "", e.openNodeInModal === !0 ? {} : e.openNodeInModal) : e.link ? this.luigi.navigation().navigate(e.link) : e.externalLink?.url && H.openExternalLink(e.externalLink);
		}, l = n.userSettings, d = {};
		l && (d = {
		...
		let f = {
			...
			onUserInfoUpdate: (e) => {
				this.luigi.getConfigValueAsync("navigation.profile.staticUserInfoFn").then((t) => {
					t ? e(t) : ki.getUserInfoStore().subscribe((t) => {
						e(t);
					});
				});
			}
		}, p = n?.globalSearch, m = r.selectedNode, h = m && r.rootNodes.includes(m) ? m : void 0, g = await this.buildContextSwitcher(), _ = {
			...n.navigation?.productSwitcher,
			productSwitcherItemClick: (e) => {
				e.externalLink?.url ? H.openExternalLink(e.externalLink) : e.link && this.luigi.navigation().navigate(e.link);
			}
		...
		return p?.searchProvider?.inputPlaceholder && (y = {
			...
			appSwitcher: n.navigation?.appSwitcher && this.getAppSwitcherData(n.navigation?.appSwitcher, n.settings?.header),
	...
	getAppSwitcherData(e, t) {
		...
		if (n && n.items && r) {
			...
			})), n.items.some((t) => t.link === e.link)) return n;
			n.items.unshift(e);
		}
		return n;
	}
	async getTabNavData(e, t) {
		let n = t ?? await this.getPathData(e);
		if (e === "" && n?.nodesInPath?.[0].viewUrl) return {};
		let r = n?.selectedNode, i;
		if (!r || !r.tabNav && (i = this.getParentNode(r, n), i && !i.tabNav)) return {};
		let a = i || r, o = this.getTabNavConfig(a);
		o && !("hideTabNavAutomatically" in o) && !o.showAsTabHeader && console.warn("tabNav:{hideTabNavAutomatically:true|false} is not configured correctly.");
		let s = "";
		n.nodesInPath?.forEach((e) => {
		...
		let l = await this.buildNavItems(c, r, n), u = {
			selectedNode: r,
			items: l.items,
		...
		return o?.showAsTabHeader && a.webcomponent && a.viewUrl && (u.headerNode = {
			viewUrl: a.viewUrl,
	...
	async getBreadcrumbData(e, t, n) {
		let r = this.luigi.getConfigValue("navigation.breadcrumbs"), i = t ?? await this.getPathData(e), a = i?.nodesInPath || [], o = [], s = !!r, c = "";
		if (!r || e === "" && a?.[0].viewUrl) return this.previousBreadcrumbs = {}, {};
		if (a.forEach((e) => {
			e.children && (c += "/" + (e.pathSegment || "")), e.showBreadcrumbs === !1 ? s = !1 : e.showBreadcrumbs === !0 && (s = !0);
		}), !s) return { clearBeforeRender: !0 };
		let l = this.luigi.getConfigValue("routing.useHashRouting"), u = U.getCurrentPath(this.luigi, l), d = r.omitRoot ? 2 : 1;
		for (let e = d; e < a.length; e++) {
			let t = a[e], n = U.mapPathToNode(u.path, t);
			if (n && this.previousBreadcrumbs[n]) o.push(this.previousBreadcrumbs[n]);
			else if (t.label || t.pathSegment || t.titleResolver) if (t.titleResolver) o.push({
				label: t.titleResolver.prerenderFallback && t.titleResolver.fallbackTitle ? this.luigi.i18n().getTranslation(t.titleResolver.fallbackTitle) : r.pendingItemLabel || "",
				node: t,
				route: n,
				pending: !0
			});
		...
		if (u.path === U.getCurrentPath(this.luigi, l).path) {
			let e = {};
			o.length > 1 ? o[o.length - 1].last = !0 : r.autoHide && (o.length = 0), o.map((t) => {
				t.route && (e[t.route] = t);
	...
	async resolveBreadcrumbTitles(e, t, n, r, i, a, o) {
		...
		for (let r = t; r < e.length; r++) {
			let t = e[r], i = U.mapPathToNode(n.path, t);
			if (t.titleResolver) try {
				let e = await this.extractDataFromPath(i || ""), n = U.substituteDynamicParamsInObject(Object.assign({}, e.pathData.context, t.context), e.pathData.pathParams || {}), r = await H.fetchNodeTitleData(t, n);
				s.push({
					label: r.label,
					node: t,
					route: i
		...
		if (n.path === U.getCurrentPath(this.luigi, r).path) {
			let e = {};
			s.length > 1 ? s[s.length - 1].last = !0 : i.autoHide && (s.length = 0), s.map((t) => {
				t.route && (e[t.route] = t);
			}), this.previousBreadcrumbs = e;
		}
		o(a(s));
	...
	async shouldPreventNavigation(e) {
		return !!(e?.onNodeActivation && (a.isFunction(e.onNodeActivation) || a.isAsyncFunction(e.onNodeActivation)) && await e.onNodeActivation(e) === !1);
	}
	...
	async handleNavigationRequest(e, t) {
		let { path: n, intent: r, preserveView: i, drawerSettings: o, modalSettings: s, newTab: c, withoutSync: l, preventContextUpdate: u, preventHistoryEntry: d, options: f } = e, p = this.luigi.getConfig().routing?.useHashRouting, m = !!(o || s), h = f?.nodeParams, g = m ? {
			...f,
			nodeParams: {}
		} : f, _ = await this.buildPath(n, g || {});
		...
		let v = _.replace(/\/\/+/g, "/"), y = d ? "replaceState" : "pushState", { path: b, query: x } = U.getCurrentPath(this.luigi, p), S = b + (x ? "?" + x : "");
		if (!(!(o || s) && a.trimLeadingSlash(S) === a.trimLeadingSlash(v))) if (o || s) if (o) h && Object.keys(h).length > 0 && (o.nodeParams = h), this.luigi.navigation().openAsDrawer(v, o, t);
		else {
			...
			if (G.drawerContainer && t.shouldShowUnsavedChangesModal(G.drawerContainer)) try {
	...
	async getChildren(e, t = {}) {
		...
		if (n.hasChildren(e)) {
			...
			r = await o.getConfigValueFromObjectAsync(e, "children", t || e.context), r ??= [], r = r.map((e) => this.getExpandStructuralPathSegment(e)).map((t) => this.bindChildToParent(t, e)) || [];
		} catch (e) {
			console.error("Could not lazy-load children for node", e);
		}
		let i = this.getAccessibleNodes(e, r, t);
		return n.setChildren(e, {
			children: r,
			filteredChildren: i
		}), i;
	}
	getExpandStructuralPathSegment(e) {
		if (e && e.pathSegment && e.pathSegment.indexOf("/") !== -1) {
			let t = e.pathSegment.split("/"), n = { ...e }, r = (e, t) => {
				let i = e.shift(), a = {};
				return e.length ? (a.pathSegment = i, t.hideFromNav && (a.hideFromNav = t.hideFromNav), a.children = [r(e, t)]) : (a = n, a.pathSegment = i), a;
			};
			return r(t, e);
		}
		return e;
	...
	buildVirtualTree(e, t, n) {
		let r = e.virtualTree, i = e._virtualTree, o = e._virtualViewUrl || e.viewUrl;
		if ((r || i) && t) {
			...
			return e.children && !c && console.warn("Found both virtualTree and children nodes defined on a navigation node. \nChildren nodes are redundant and ignored when virtualTree is enabled. \nPlease refer to documentation"), [s];
		}
	}
	...
	async buildPath(e, t) {
		let { fromVirtualTreeRoot: n, fromContext: r, fromClosestContext: i, fromParent: a, relative: o, nodeParams: s } = t, c = this.luigi.getConfigValue("routing.useHashRouting"), { path: l, query: u } = U.getCurrentPath(this.luigi, c), d = l + (u ? "?" + u : ""), f = await this.getPathData(d), p = f.nodesInPath, m = e;
		if (p === void 0) return console.warn("No nodes in path found for current path:", d), m;
		if (n) {
			m = "";
			let t = [...p].map((e, t) => e.virtualTree ? t : -1).filter((e) => e !== -1).pop();
			p.forEach((e, n) => {
				e.pathSegment && (t === void 0 || n <= t) && (m += "/" + e.pathSegment);
			}), m += "/" + e;
		} else if (r) {
			let t = r, n = [...p].reverse().find((e) => t === e.navigationContext);
		...
		} else a ? m = U.concatenatePath(U.getSubPath(f.selectedNode?.parent, f.pathParams), e) : o && (m = U.concatenatePath(U.getSubPath(f.selectedNode, f.pathParams), e));
		return s && Object.keys(s).length > 0 && (m += m.includes("?") ? "&" : "?", Object.entries(s).forEach((e, t) => {
			m += encodeURIComponent(U.getContentViewParamPrefix(this.luigi) + e[0]) + "=" + encodeURIComponent(e[1]) + (t < Object.keys(s).length - 1 ? "&" : "");
		})), m;
	}
	async getCurrentRoutePath(e) {
		let { fromVirtualTreeRoot: t, fromContext: n, fromClosestContext: r, fromParent: i } = e, a = this.luigi.getConfigValue("routing.useHashRouting"), { path: o, query: s } = U.getCurrentPath(this.luigi, a), c = o + (s ? "?" + s : ""), l = await this.getPathData(c), u = l.nodesInPath;
		if (!u || !l.selectedNode) return "";
		let d = U.getSubPath(l.selectedNode, l.pathParams);
		if (t) {
			let e = [...u].reverse().find((e) => e.virtualTree);
			if (!e) {
				console.error("LuigiClient Error: fromVirtualTreeRoot() is not possible because you are not inside a Luigi virtualTree navigation node.");
				return;
			}
			...
			let e = [...u].reverse().find((e) => e.navigationContext && e.navigationContext.length > 0), t = U.getSubPath(e, l.pathParams);
			return d.split(t).join("");
		} else if (n) {
			let e = [...u].reverse().find((e) => n === e.navigationContext), t = U.getSubPath(e, l.pathParams);
			return d.split(t).join("");
		}
		return d;
	}
	async buildContextSwitcher() {
		...
		let t = await this.luigi.getConfigValueAsync("navigation.contextSwitcher.actions"), n = await pi.fetchOptions(this.luigi), r = this.luigi.getConfig().routing?.useHashRouting, i = U.getCurrentPath(this.luigi, r), a = e.parentNodePath, o = e.fallbackLabelResolver, s = await pi.getSelectedLabel(i?.path, n, a, o, this.luigi), c = pi.getSelectedNode(i?.path, n, a), l = pi.getSelectedOption(i?.path, n, a), u = (e, n) => {
			if (!(!e || typeof e != "string")) if (n === "action") {
		...
		if (e?.preserveSubPathOnSwitch && n?.length && l && n.forEach((e) => {
			e.linkFromPath = pi.getNodePathFromCurrentPath(e, l, this.luigi), e.link === l.link && (l.linkFromPath = e.linkFromPath);
		}), !l && t?.length) {
	...
	preloadViewGroups(e = 3, t) {
		let n = this.luigi.getConfigValue("navigation.preloadViewGroups"), r = this.luigi.getConfigValue("navigation.viewGroupSettings"), i = this.luigi.getEngine()._connector?.getContainerWrapper();
		if (n === !1 || !r || !i) return;
		let a = Date.now();
		...
		let o = [...i.childNodes].filter((e) => e.tagName?.startsWith("LUIGI-") && e.viewGroup).map((e) => e.viewGroup), s = Object.entries(r).filter(([e]) => !o.includes(e)).filter(([e, t]) => t && t.preloadUrl);
		t ? s.forEach(([e, t]) => {
			t.loadOnStartup && this.preloadContainerOnBackground(t, e, i);
		}) : s.filter((t, n) => n < e).forEach(([e, t]) => {
			this.preloadContainerOnBackground(t, e, i);
		});
	}
	preloadContainerOnBackground(e, t, n) {
		let r = document.createElement("luigi-container");
		r.setAttribute("lui_container", "true"), r.viewurl = e.preloadUrl, r.viewGroup = t, r.style.display = "none", r._luigiPreloading = !0, r._luigiPreloadCreatedAt = Date.now(), r.luigiMfId = a.getRandomId(), this.luigi.getEngine()._comm.addListeners(r, this.luigi);
	...
	preload(e) {
		this.shouldPreload && setTimeout(() => {
			this.preloadViewGroups(this.preloadBatchSize, !!e);
		}, +!!e), this.shouldPreload = !0;
	}
	viewGroupLoaded(e) {
		if (e._luigiPreloading) {
			let t = Date.now() - (e._luigiPreloadCreatedAt || 0), n = 1;
			t < 500 ? n = 3 : t < 1e3 && (n = 2), this.preloadBatchSize = n, setTimeout(() => {
	...
	removeEventListener(e, t) {
		this.listeners = this.listeners.filter((n) => !(n.type === e && n.listenerFn === t)), window.removeEventListener(e, t);
	},
	...
	getNavigationService() {
		return this.navigationService || (this.navigationService = W.get(yi), this.dirtyStatusService = W.get(gi)), this.navigationService;
	}
	shouldSkipRoutingForUrlPatterns() {
		return (this.luigi.getConfigValue("routing.skipRoutingForUrlPatterns") || [/access_token=/, /id_token=/]).filter((e) => location.href.match(e)).length !== 0;
	}
	enableRouting() {
		this.luigi.getConfig().routing?.useHashRouting ? (xi.addEventListener("hashchange", (e) => {
			let t = !!e?.detail?.preventContextUpdate, n = !!e?.detail?.withoutSync;
			this.handleRouteChange(U.getCurrentPath(this.luigi, !0, !0), n, t);
		}), this.handleRouteChange(U.getCurrentPath(this.luigi, !0, !0))) : (xi.addEventListener("popstate", (e) => {
			let t = !!e?.detail?.preventContextUpdate, n = !!e?.detail?.withoutSync;
	...
	async handleRouteChange(e, t = !1, n = !1) {
		let r = e.path, i = e.query, o = r + (i ? "?" + i : ""), s = new URLSearchParams(i), c = Object.create(null);
		try {
		...
		this.setFeatureToggle(o), await this.shouldShowModalPathInUrl(e), s.forEach((e, t) => {
			c[t] = e;
		}), this.checkInvalidateCache(this.previousPathData, r);
		let l = await this.getNavigationService().getPathData(r), u = U.filterNodeParams(c, this.luigi), d = a.getPathWithoutHash(r) || "";
		this.currentRoute = {
		...
		if (m?.renderTopNav(await this.getNavigationService().getTopNavData(r, l)), m?.renderLeftNav(await this.getNavigationService().getLeftNavData(r, l)), m?.renderTabNav(await this.getNavigationService().getTabNavData(r, l)), m?.renderBreadcrumbs(await this.getNavigationService().getBreadcrumbData(r, l, (e) => {
			...
			this.currentRoute.node = f, this.getNavigationService().onNodeChange(this.previousNode, f), this.previousNode = f, await G.updateMainContent(f, this.luigi, e, t, n), this.previousPathData = l;
		}
	}
	getCurrentRoute() {
	...
	async handleBookmarkableModalPath(e) {
		let t = W.get(yi), n = W.get(_i), r = new URLSearchParams(e?.query || ""), i = U.getModalViewParamName(this.luigi), a = r.get(i);
		if (a) {
			let e = r.get(`${i}Params`);
			try {
				let n = JSON.parse(e || "{}"), { nodeObject: r } = await t.extractDataFromPath(a);
				document.querySelector(".lui-modal luigi-container") ? this.luigi.getEngine()._connector?.updateModalSettings(n) : this.luigi.navigation().openAsModal(a, n || r.openNodeInModal);
			} catch (e) {
	...
	appendModalDataToUrl(e, t) {
		let n = U.getHashQueryParamSeparator(), r = U.getQueryParams(this.luigi), i = U.getModalViewParamName(this.luigi), a = r[i], o = new URL(location.href), s = this.luigi.getConfigValue("routing.useHashRouting"), c = history.state, l, u;
		if (s) {
			let [e, t] = o.hash.split("?");
			l = e, u = U.getURLWithoutModalData(t, i), u && (l += "?" + u);
		} else l = o.pathname, u = U.getURLWithoutModalData(o.search, i), u && (l += "?" + U.getURLWithoutModalData(o.search, i));
		if (c = U.handleHistoryState(c, l), a !== e) {
			...
			let e = new URL(o);
			s ? (e.hash = e.hash.split("?")[0], u && (e.hash += "?" + u)) : e.search = u, history.replaceState({}, "", e.href), history.pushState(c, "", o.href);
		}
	}
	removeModalDataFromUrl(e) {
		let t = U.getQueryParams(this.luigi), n = U.getModalViewParamName(this.luigi), r = new URL(location.href);
		if (this.luigi.getConfigValue("routing.useHashRouting")) {
			let e = {};
			t[n] && (e[n] = t[n]), t[`${n}Params`] && (e[`${n}Params`] = t[`${n}Params`]);
			let i = U.encodeParams(e);
			r.hash.includes(`?${i}`) ? r.hash = r.hash.replace(`?${i}`, "") : r.hash.includes(`&${i}`) && (r.hash = r.hash.replace(`&${i}`, ""));
		} else {
		...
		if (history.state && history.state.modalHistoryLength >= 0 && e) {
			...
			let e = history.state.pathBeforeHistory, t = !1;
			if (window.addEventListener("popstate", (n) => {
				t ? (history.replaceState({}, "", e), history.pushState({}, "", e), history.back()) : (history.pushState({}, "", e), history.back());
			}, { once: !0 }), history.state.historygap === history.length - history.state.modalHistoryLength) history.go(-history.state.modalHistoryLength);
	...
	setFeatureToggle(e) {
		let t = this.luigi.getConfigValue("settings.featureToggles.queryStringParam"), n = this.luigi.featureToggles();
		t && typeof e == "string" && U.setFeatureToggles(t, e, n);
	}
	updateModalDataInUrl(e, t, n) {
		let r = U.getHashQueryParamSeparator(), i = U.getQueryParams(this.luigi), a = U.getModalViewParamName(this.luigi);
	...
	checkInvalidateCache(e, t) {
		if (!e) return;
		let n = W.get(vi), r = t.split("/");
		if (e.nodesInPath && e.nodesInPath.length > 0) {
			let t = e.nodesInPath.slice(1), i = !0;
			for (let a = 0; a < t.length; a++) {
				let o = r.length > a ? r[a] : void 0, s = t[a];
				if (o !== s.pathSegment || !i) if (U.isDynamicNode(s)) {
	...
	async handlePageNotFound(e, t, n, r, i) {
		let o = a.getTrimmedUrl(r), s = U.isExistingRoute(o, n);
		if (!t && !e?.compound || e?.tabNav?.showAsTabHeader) {
			...
			if (s) {
				...
				return this.getNavigationService().handleNavigationRequest({
					path: `${t ? `/${t}` : ""}/${e}`,
					preserveView: void 0,
				...
				if (e && n?.nodesInPath && n.nodesInPath.length > 1) return this.showPageNotFoundError(a.trimTrailingSlash(o || "") + "/" + e, i, !0), !0;
	...
	async showPageNotFoundError(e, t, n = !1) {
		...
		if (i) {
			if (r.keepURL) {
				let e = this.luigi.getConfig().routing?.useHashRouting, t = U.getCurrentPath(this.luigi, e);
				t.path = i, this.handleRouteChange(t);
			} else this.getNavigationService().handleNavigationRequest({ path: i });
			return;
		}
		U.showRouteNotFoundAlert(t, n, this.luigi), this.getNavigationService().handleNavigationRequest({ path: a.addLeadingSlash(e) });
	}
	async handleViewUrlMisconfigured(e, t, n, r) {
		let { children: i, intendToHaveEmptyViewUrl: a, compound: o } = e, s = !!i?.length;
		if (!o && t.trim() === "" && !s && !a) {
			if (console.warn("The intended target route can't be accessed since it has neither a viewUrl nor children. This is most likely a misconfiguration."), !(n && (n.selectedNode?.viewUrl || n.selectedNode && n.selectedNode.compound))) {
				let e = await this.getNavigationService().getPathData("/"), t = await U.getDefaultChildNode(e);
	...
	applyDecorators(e, t) {
		if (!e) return e;
		let n = new URL(a.prependOrigin(e)), r = this.decorators.filter((e) => e.type === "queryString");
	...
	let i = await t.readUserSettings(), o = e.userSettingsGroup && typeof i == "object" && i && e.userSettingsGroup ? i[e.userSettingsGroup] : null, s = n?.nodeParams || {}, c = n?.pathParams || {}, l = n?.searchParams || {};
	if (e.webcomponent && e.viewUrl && !U.checkWCUrl(e.viewUrl, t)) return console.warn(`View URL '${e.viewUrl}' not allowed to be included`), document.createElement("div");
	if (e.compound) {
		let n = document.createElement("luigi-compound-container");
		return console.log("LuigiCompoundContainer:"), console.log(t.i18n().getCurrentLocale()), console.log(t.theming().getCurrentTheme()), n.setAttribute("lui_container", "true"), n.viewurl = e.viewUrl ? W.get(Ci).applyDecorators(U.substituteViewUrl(e, c, s, t), e.decodeViewUrl ?? !1) : "", n.webcomponent = e.webcomponent ?? !1, n.compoundConfig = e.compound, n.context = e.context, n.clientPermissions = e.clientPermissions ?? {}, n.nodeParams = s, n.pathParams = c, n.userSettingsGroup = e.userSettingsGroup, n.userSettings = o, n.searchParams = l, n.activeFeatureToggleList = t.featureToggles().getActiveFeatureToggleList(), n.locale = t.i18n().getCurrentLocale(), n.theme = t.theming().getCurrentTheme(), n.viewGroup = e.viewGroup, n.virtualTree = e.virtualTree || e._virtualTree, n.virtualTreeRootNode = H.findVirtualTreeRootNode(e), t.getEngine()._comm.addListeners(n, t), n;
	} else {
		let n = document.createElement("luigi-container");
		return n.setAttribute("lui_container", "true"), n.viewurl = e.viewUrl ? W.get(Ci).applyDecorators(U.substituteViewUrl(e, c, s, t), e.decodeViewUrl ?? !1) : "", n.webcomponent = e.webcomponent ?? !1, n.context = e.context, n.authData = u.getStoredAuthData(), n.clientPermissions = e.clientPermissions ?? {}, n.cssVariables = await t.theming().getCSSVariables(), n.nodeParams = s, n.pathParams = c, n.userSettingsGroup = e.userSettingsGroup, n.userSettings = o, n.searchParams = l, n.activeFeatureToggleList = t.featureToggles().getActiveFeatureToggleList(), n.locale = t.i18n().getCurrentLocale(), n.theme = t.theming().getCurrentTheme(), n.viewGroup = e.viewGroup, n.virtualTree = e.virtualTree || e._virtualTree, n.virtualTreeRootNode = H.findVirtualTreeRootNode(e), Ti(n, t), Ei(n, t), Di(n, t, e, r || "main"), Oi(n, t, e, r || "main"), t.getEngine()._comm.addListeners(n, t), n.luigiMfId = a.getRandomId(), n;
	}
}, Ti = (e, t) => {
	...
	a.isFunction(i) && (e.webcomponentCreationInterceptor = i, e.currentNode = n, e._luigiMicroFrontendType = r !== "main");
}, G = {
	navService: void 0,
	...
	init: (e) => {
		G.navService = W.get(yi), G.routingService = W.get(Si), G.luigi = e, e.getEngine()._connector?.renderMainLayout();
		let t = W.get(bi);
	...
	update: async (e) => {
		...
		if (!t) return;
		let n = !e || e.length === 0;
		if ((n || e.includes("navigation") || e.includes("navigation.nodes")) && W.get(vi).deleteCache(), e?.length === 1 && e[0] === "navigation.viewgroupdata") {
			let e = await G.navService.getPathData(t.path), n = G.luigi.getEngine()._connector, [r, i, a, o] = await Promise.all([
		...
		if ((n || e.includes("settings.header") || e.includes("settings") || e.includes("navigation") || e.includes("navigation.badges") || e.includes("navigation.profile") || e.includes("navigation.contextSwitcher") || e.includes("navigation.productSwitcher") || e.includes("navigation.viewgroupdata")) && G.luigi.getEngine()._connector?.renderTopNav(await G.navService.getTopNavData(t.path)), (n || e.includes("navigation") || e.includes("navigation.nodes") || e.includes("navigation.viewgroupdata") || e.includes("settings") || e.includes("settings.footer")) && G.luigi.getEngine()._connector?.renderLeftNav(await G.navService.getLeftNavData(t.path)), n || e.includes("navigation") || e.includes("navigation.nodes") || e.includes("navigation.viewgroupdata") || e.includes("settings") || e.includes("settings.footer")) {
			G.luigi.getEngine()._connector?.renderTabNav(await G.navService.getTabNavData(t.path));
			let e = G.luigi.getEngine()._connector;
			e?.renderBreadcrumbs(await G.navService.getBreadcrumbData(t.path, void 0, (t) => {
	...
	updateMainContent: async (e, t, n, r, i) => {
		let o = await t.readUserSettings(), s = e.userSettingsGroup && typeof o == "object" && o && e.userSettingsGroup ? o[e.userSettingsGroup] : null, c = t.getEngine()._connector?.getContainerWrapper();
		t.getEngine()._connector?.hideLoadingIndicator(c);
		let l = n?.nodeParams || {}, u = n?.pathParams || {}, d = n?.searchParams || {};
		if (e && c) {
			let o, f, p;
			...
			if ([...c.childNodes].forEach((n) => {
				if (n.tagName?.indexOf("LUIGI-") === 0) if (r && (o = n), n.viewGroup && e.viewGroup !== n.viewGroup) {
					if (!r) {
						n.style.display = "none";
						let e = t.getConfigValue("navigation.viewGroupSettings")?.[n.viewGroup];
						e?.preloadUrl && (n.viewurl = e.preloadUrl, n.context = {}, n.nodeParams = {}, n.pathParams = {});
					}
				} else r || n.viewGroup || n.virtualTree && p === n.virtualTreeRootNode || !e.viewGroup && !e.isolateView && !e.webcomponent && n.viewurl && (i || m && a.isSameUrl(n.viewurl, m)) ? f = n : r || n.remove();
			}), f && f._luigiPreloading && (f._luigiPreloading = !1, W.get(bi).viewGroupLoaded(f)), f) {
				let n = f.viewurl;
				!r && !i && (f.style.display = "block", f.viewurl = m, f.nodeParams = l, f.pathParams = u, f.clientPermissions = e.clientPermissions, f.searchParams = d, f.locale = t.i18n().getCurrentLocale(), f.theme = t.theming().getCurrentTheme(), f.activeFeatureToggleList = t.featureToggles().getActiveFeatureToggleList(), f.userSettingsGroup = e.userSettingsGroup, f.userSettings = s, Ti(f, t), Ei(f, t)), r && !i && (f.nodeParams = l, f.pathParams = u, f.searchParams = d), i || (a.isSameUrl(n, m) && n !== m && !f.virtualTree && !r ? (f.context = e.context || {}, f.updateViewUrl(m)) : f.updateContext(e.context || {}, { withoutSync: !!r }));
	...
	openModal: async (e, t, n, r, i) => {
		...
		let o = W.get(Si), s = W.get(_i), c = W.get(gi), l = !1, u, d, f = new Promise((t) => {
			u = () => {
				...
				u && u(), e.getConfigValue("routing.showModalPathInUrl") && s.getModalStackLength() === 0 && o.removeModalDataFromUrl(!0);
			}, a.addEventListener(V.CLOSE_CURRENT_MODAL_REQUEST, d), a.addEventListener(V.GO_BACK_REQUEST, async (t) => {
				try {
					await c.getUnsavedChangesModalPromise(a);
				} catch {
					return;
				...
				if (r?.(n), u && u(), e.getConfigValue("routing.showModalPathInUrl") && s.getModalStackLength() === 0 && o.removeModalDataFromUrl(!0), n && Object.keys(n).length) {
					let t = e.getEngine()._connector?.getContainerWrapper();
					if (t) {
						let e = [...t.childNodes].find((e) => e.tagName?.indexOf("LUIGI-") === 0 && e.style?.display !== "none");
		...
		s.registerModal(p), e.getEngine()._connector?.renderModal(a, n, async () => {
			try {
				await c.getUnsavedChangesModalPromise(a);
			} catch {
				return;
			}
			r?.(), u && u(), e.getConfigValue("routing.showModalPathInUrl") && s.getModalStackLength() === 0 && o.removeModalDataFromUrl(!0);
		}, () => f);
	...
	updateModalSettings: (e, t, n) => {
		...
		let i = W.get(Si), a = U.getModalPathFromPath(n);
		a && i.updateModalDataInUrl(a, r.getModalSettings(), t), n.getEngine()._connector?.updateModalSettings(r.getModalSettings());
	},
	openDrawer: async (e, t, n, r, i) => {
		let a = W.get(gi);
		if (G.drawerContainer && a.shouldShowUnsavedChangesModal(G.drawerContainer)) try {
		...
		e.getEngine()._connector?.renderDrawer(o, n, async () => {
			try {
				await a.getUnsavedChangesModalPromise(o);
			} catch {
				return;
	...
	openUserSettings: async (e, t, n, r) => {
		...
		e.renderMicroFrontendContainer = async (e, t) => {
			let a = e.viewUrl, o = e.webcomponent ?? !1, s = n?.[t] || {}, c = await wi({
				viewUrl: a,
				userSettingsGroup: t,
				webcomponent: o,
				context: {
			...
			}, r, void 0, "usersettings");
			return c.addEventListener(V.CUSTOM_MESSAGE, (e) => {
				let n = e.detail;
	...
	async init() {
		...
		let t = s.getConfigValue(`auth.${e}`), n = u.parseUrlAuthErrors() || {};
		if (await u.handleUrlAuthErrors(t, n.error, n.errorDescription)) return this.idpProviderInstance = this.getIdpProviderInstance(e, t), a.isPromise(this.idpProviderInstance) ? this.idpProviderInstance.then((e) => (this.idpProviderInstance = e, this.checkAuth(t))).catch((e) => {
	...
	async checkAuth(e) {
		...
		this.idpProviderInstance.settings && a.isFunction(this.idpProviderInstance.settings.userInfoFn) ? this.idpProviderInstance.settings.userInfoFn(this.idpProviderInstance.settings, t).then((e) => {
			this.setUserInfo(e), this.setLoggedIn(!0);
		}) : a.isFunction(this.idpProviderInstance.userInfo) ? this.idpProviderInstance.userInfo(e).then((e) => {
			this.setUserInfo(e), this.setLoggedIn(!0);
		}) : (this.setLoggedIn(!0), this.setUserInfo(n(this._userInfoStore))), a.isFunction(s.getConfigValue("auth.events.onAuthSuccessful")) && c.isNewlyAuthorized() && await l.handleAuthEvent("onAuthSuccessful", e, t), c.removeNewlyAuthorized(), a.isFunction(this.idpProviderInstance.setTokenExpirationAction) && this.idpProviderInstance.setTokenExpirationAction(), a.isFunction(this.idpProviderInstance.setTokenExpireSoonAction) && this.idpProviderInstance.setTokenExpireSoonAction();
	}
	async startAuthorization() {
		if (this.idpProviderInstance) return this.idpProviderInstance.login().then((e) => {
			c.setNewlyAuthorized(), e && console.error(e);
		});
	}
	logout() {
		let e = u.getStoredAuthData(), t = async (e) => {
			await l.handleAuthEvent("onLogout", this.idpProviderInstance.settings, void 0, e), c.removeAuthData();
		}, n = s.getConfigValue(`auth.${s.getConfigValue("auth.use")}.logoutFn`), r = s.getConfigValueAsync("navigation.profile.logout.customLogoutFn");
		a.isFunction(n) ? n(this.idpProviderInstance.settings, e, t) : a.isFunction(this.idpProviderInstance.logout) ? this.idpProviderInstance.logout(e, t) : r && a.isFunction(r) ? r(e, t) : t(this.idpProviderInstance.settings.logoutUrl);
	}
	...
	async getIdpProviderInstance(e, t) {
		...
		if (n) {
			let r = await new n(t);
			return ["login"].forEach((t) => {
				if (!a.isFunction(r[t])) throw this.createIdpProviderException(`${t} function does not exist in custom IDP Provider ${e}`);
			}), r;
		}
		if (a.isFunction(s.getConfigValue("auth.events.onAuthConfigError"))) await l.handleAuthEvent("onAuthConfigError", {
			idpProviderName: e,
	...
	resetExpirationChecks() {
		this.idpProviderInstance && a.isFunction(this.idpProviderInstance.resetExpirationChecks) && this.idpProviderInstance.resetExpirationChecks();
	}
	broadcastAuthData(e) {
		...
		if (t) {
			...
			G.modalContainer?.forEach((t) => t.setAttribute("auth-data", JSON.stringify(e))), G.drawerContainer && G.drawerContainer.setAttribute("auth-data", JSON.stringify(e));
		}
	}
}(), Ai = { luigi: {
	button: {
	...
	translationTable;
	constructor(e) {
		this.luigi = e, this.currentLocaleStorageKey = "luigi.currentLocale", this.defaultLocale = "en", this.listeners = {}, this.translationTable = Ai;
	}
	_init() {
		this._initCustomImplementation(), this.addCurrentLocaleChangeListener((e) => {
	...
	setCurrentLocale(e) {
		e && (sessionStorage.setItem(this.currentLocaleStorageKey, e), this._notifyLocaleChange(e)), this.luigi.getEngine()._connector?.setCurrentLocale(e);
	}
	addCurrentLocaleChangeListener(e) {
		let t = null;
		return a.isFunction(e) ? (t = a.getRandomId(), this.listeners[t] = e) : console.error("Provided locale change listener is not a function."), t;
	}
	...
	_initCustomImplementation() {
		this.translationImpl = this.luigi.getConfigValue("settings.customTranslationImplementation"), a.isFunction(this.translationImpl) && (this.translationImpl = this.translationImpl());
	}
	...
	findInterpolations(e, t) {
		return typeof e != "string" || !e.trim() || Object.keys(t).forEach((n) => {
	...
	getMainMicrofrontends(e) {
		...
		if (!t) return [];
		let n = [];
		for (let e of t.childNodes) if (e.tagName?.startsWith("LUIGI-")) if (e.iframeHandle?.iframe) n.push({
	...
	getModalMicrofrontends() {
		let e = [];
		for (let t of G.modalContainer) if (t.iframeHandle?.iframe) e.push({
	...
	getDrawerMicrofrontends() {
		...
		if (G.drawerContainer.iframeHandle?.iframe) return {
	...
	getAllLuigiContainerIframe(e) {
		...
		return G.drawerContainer && G.drawerContainer.iframeHandle?.iframe && n.push(G.drawerContainer), n.length > 0 ? n : void 0;
	}
}, Ni = class {
	luigi;
	constructor(e) {
	...
	getMicrofrontendIframes() {
		let e = this.luigi.getEngine()._connector?.getContainerWrapper(), t = [];
		if (G.modalContainer) for (let e of Array.from(G.modalContainer)) e.tagName?.startsWith("LUIGI-") && e.iframeHandle?.iframe && t.push(e.iframeHandle.iframe);
		if (G.drawerContainer && t.push(G.drawerContainer.iframeHandle.iframe), !e) return null;
		for (let n of Array.from(e.childNodes)) n.tagName?.startsWith("LUIGI-") && n.iframeHandle?.iframe && t.push(n.iframeHandle.iframe);
		return t;
	}
	getCurrentMicrofrontendIframe() {
		let e = this.luigi.getEngine()._connector?.getContainerWrapper();
		if (!e) return null;
		let t = G.modalContainer[0]?.iframeHandle?.iframe ?? null, n = null, r = null;
		for (let t of Array.from(e.children)) t.tagName?.startsWith("LUIGI-") && a.isElementVisible(t) && (t.iframeHandle?.iframe ? n = t.iframeHandle.iframe : r = t.shadowRoot?.firstElementChild?.firstElementChild ?? null);
		return t || n || r;
	}
}, Pi = { luigiAfterInit: async (e) => {
	a.getConfigBooleanValue(e.getConfig(), "settings.appLoadingIndicator.hideAutomatically") && setTimeout(() => {
		e.ux().hideAppLoadingIndicator();
	}, 0), await s.executeConfigFnAsync("lifecycleHooks.luigiAfterInit");
} }, Fi = class {
	featureToggleList;
	constructor() {
	...
	isDuplicatedOrDisabled(e) {
		return this.featureToggleList.has(e) ? (console.warn("Feature toggle name already exists"), !0) : this.featureToggleList.has(`!${e}`) ? (console.warn("Disabled feature toggle can not be activated"), !0) : !1;
	}
}, Ii = class {
	luigi;
	...
	showSearchResult(e) {
		let t = this.luigi.getConfigValue("globalSearch.searchFieldCentered") && this.luigi.getConfigValue("settings.experimental.globalSearchCentered");
		e?.length ? this.getHandler()?.showSearchResult(e, this.searchQuery, !!t, (t) => {
			t && a.isFunction(this.searchProvider.customSearchResultRenderer) ? mi.handleSearchResultRenderer(this.searchProvider, e, t) : (this.isSearchResultVisible = !0, this.searchResult = e);
	...
	setSearchQuery(e) {
		this.searchQuery = e || "", this.getHandler()?.setSearchString(this.searchQuery, (e) => {
			e && (e.value = this.searchQuery, this.searchProvider.onInput && a.isFunction(this.searchProvider.onInput) ? this.searchProvider.onInput() : console.error("onInput is not a function. Please check the global search configuration."));
		});
	}
	...
	openSearchField() {
		this.globalSearchService.hasSearchProvider() && (this.globalSearchService.setFieldVisibility(!0), this.luigi.getEngine()._connector?.getGlobalSearchHandler?.()?.openSearchField());
	}
	closeSearchField() {
		this.globalSearchService.hasSearchProvider() && (this.globalSearchService.setFieldVisibility(!1), this.luigi.getEngine()._connector?.getGlobalSearchHandler?.()?.closeSearchField());
	}
	clearSearchField() {
		this.globalSearchService.hasSearchProvider() && (this.globalSearchService.setSearchQuery(""), this.luigi.getEngine()._connector?.getGlobalSearchHandler?.()?.clearSearchField(), this.closeSearchResult());
	}
	showSearchResult(e) {
		this.globalSearchService.hasSearchProvider() && this.globalSearchService.showSearchResult(e);
	}
	closeSearchResult() {
		this.globalSearchService.closeSearchResult(), this.luigi.getEngine()._connector?.getGlobalSearchHandler?.()?.closeSearchResult();
	}
	getSearchString() {
	...
	constructor(e) {
		this.luigi = e, this.hashRouting = e.getConfig().routing?.useHashRouting, this.navService = W.get(yi), this.routingService = W.get(Si), this.modalService = W.get(_i);
	}
	navigate = async (e, t, n, r, i) => {
		if (e === "/" && (n || i)) return console.warn("Navigation with an absolute path prevented."), Promise.reject(/* @__PURE__ */ Error("Navigation with an absolute path prevented."));
		let a = e[0] !== "/";
	...
	openAsModal = async (e, t, n) => {
		if (e === "/") return console.warn("Navigation with an absolute path prevented."), Promise.reject(/* @__PURE__ */ Error("Navigation with an absolute path prevented."));
		if (await this.navService.shouldPreventNavigationForPath(e) || !t?.keepPrevious && !await this.modalService.closeModalsWithDirtyCheck()) return;
		let r = e.replace(/\/\/+/g, "/");
		if (!await H.validatePathAndGetRedirect(r, this.luigi)) return;
		let i = await this.navService.getCurrentNode(r), a = t || {};
		a.title ||= i?.label;
		let o = a.nodeParams || this.options.nodeParams || {}, s = r;
		if (o && Object.keys(o).length > 0) {
			let e = U.getContentViewParamPrefix(this.luigi), t = Object.entries(o).map(([t, n]) => e + encodeURIComponent(t) + "=" + encodeURIComponent(n)).join("&");
			s += (s.includes("?") ? "&" : "?") + t;
		}
		let { nodeParams: c, ...l } = a;
		this.luigi.getConfigValue("routing.showModalPathInUrl") && this.modalService.getModalStackLength() === 0 && this.routingService.appendModalDataToUrl(s, l), this.luigi.getEngine()._ui.openModal(this.luigi, i, a, n, {
			nodeParams: o,
			pathParams: {},
			searchParams: {}
		});
	...
	runTimeErrorHandler = async (e) => {
		let { path: t } = U.getCurrentPath(this.luigi, this.luigi.getConfig().routing?.useHashRouting), n = await this.navService.getCurrentNode(t), r = this.luigi.getConfigValue("navigation.defaults.runTimeErrorHandler");
		n?.runTimeErrorHandler?.errorFn && a.isFunction(n?.runTimeErrorHandler?.errorFn) ? n.runTimeErrorHandler.errorFn(e, n) : r?.errorFn && a.isFunction(r.errorFn) && r.errorFn(e, n);
	};
	pathExists = async (e) => await U.pathExists(e, this.luigi);
	fromVirtualTreeRoot() {
		return this.options.fromContext = null, this.options.fromClosestContext = !1, this.options.fromVirtualTreeRoot = !0, this.options.fromParent = !1, this;
	}
	fromContext(e) {
		return this.options.fromContext = e, this;
	}
	fromClosestContext() {
		return this.options.fromContext = null, this.options.fromClosestContext = !0, this.options.fromParent = !1, this;
	}
	fromParent() {
		return this.options.fromContext = null, this.options.fromClosestContext = !1, this.options.fromVirtualTreeRoot = !1, this.options.fromParent = !0, this;
	}
	withParams(e) {
	...
	addSearchParams(e, t = !1, n = !1) {
		...
		this.luigi.getConfigValue("routing.useHashRouting") ? r.hash = U.addParamsOnHashRouting(e, r.hash) : U.modifySearchParams(e, r.searchParams), this.handleBrowserHistory(t, r), n || this.luigi.configChanged();
	}
	getSearchParams() {
		let e = {}, t = [
			"__proto__",
	...
	addNodeParams(e, t) {
		...
		let n = U.getContentViewParamPrefix(this.luigi), r = new URL(location.href);
		this.luigi.getConfigValue("routing.useHashRouting") ? r.hash = U.addParamsOnHashRouting(e, r.hash, n) : U.modifySearchParams(e, r.searchParams, n), this.handleBrowserHistory(t, r), this.luigi.getConfigValue("routing.useHashRouting") ? window.dispatchEvent(new HashChangeEvent("hashchange")) : this.luigi.configChanged();
	}
	getAnchor() {
		let { hash: e } = new URL(window.location.href);
		return this.luigi.getConfigValue("routing.useHashRouting") && e.split("#").length === 2 ? "" : e.split("#").pop() || "";
	}
	setAnchor(e) {
		if (!(!e || e === "")) if (this.luigi.getConfigValue("routing.useHashRouting")) {
			let { hash: t } = new URL(window.location.href), n = t.split("#");
	...
	async getCSSVariables() {
		if (!window.Luigi.__cssVars) {
			...
			if (e) try {
				let t = await fetch(e);
				window.Luigi.__cssVars = (await t.json()).root, Object.keys(window.Luigi.__cssVars).forEach((e) => {
					let t = getComputedStyle(document.documentElement).getPropertyValue("--" + e);
					t && (window.Luigi.__cssVars[e] = t);
				});
			} catch (e) {
				a.isFunction(this.#e.getConfigValue("settings.theming.variables.errorHandling")) ? this.#e.getConfigValue("settings.theming.variables.errorHandling")(e) : console.error("CSS variables file error: ", e);
			}
			else this.#e.getConfigValue("settings.theming.variables") === "fiori" && window.__luigiThemeVars ? (window.Luigi.__cssVars = {}, window.__luigiThemeVars.forEach((e) => {
	...
	_init() {
		...
		(() => {
			...
			t && t.nodeViewURLDecorator && t.nodeViewURLDecorator.queryStringParameter && e.add({
				type: "queryString",
				uid: "theming",
				key: t.nodeViewURLDecorator.queryStringParameter.keyName,
				valueFn: () => {
					let e = this.getCurrentTheme(), n = t.nodeViewURLDecorator.queryStringParameter.value;
					return n ? n(e) : e;
				}
	...
	processUserSettingGroups(e, t) {
		let n = [], r = e?.userSettingGroups, i = t?.userSettings?.userSettingGroups, o = r || i;
		if (a.isObject(o)) {
			for (let e in o) {
				let t = {};
				t[e] = o[e], n.push(t);
	...
	showAlert = (e) => new Promise((t) => {
		e.id ||= a.getRandomId().toString(), this.luigi.getEngine()._connector?.renderAlert(e, {
			openFromClient: !1,
			close: () => {
				t(!0);
			},
			link: (n) => {
				if (e.links) {
					let r = e.links[n];
					if (r && (r.url && this.luigi?.navigation().navigate(r.url), r.dismissKey)) return t(r.dismissKey), !0;
				}
				return !1;
			}
		});
	...
	showConfirmationModal = (e) => {
		if (e) {
			...
			e = {
				...
				buttonConfirm: e.buttonConfirm === !1 ? !1 : this.luigi.i18n().getTranslation(e.buttonConfirm || "luigi.button.confirm")
			};
		}
	...
	openUserSettings = async () => {
		...
		if (!e) return;
		let t = this.luigi.getConfigValue("settings"), n = await this.luigi.readUserSettings(), r = Vi.processUserSettingGroups(e, t), i = e.userSettingsDialog || {}, a = i.dialogHeader || hi.userSettingsDialog.dialogHeader, o = i.saveBtn || hi.userSettingsDialog.saveBtn, s = i.dismissBtn || hi.userSettingsDialog.dismissBtn, c = {
	...
	hideAppLoadingIndicator = () => {
		...
		e && (e.classList.add("hidden"), setTimeout(() => {
	...
	sendToAll(e) {
		...
		for (let e of t) e.sendCustomMessage ? e.sendCustomMessage(n, r) : console.warn("Container does not support sending custom messages:", e);
	}
	send(e, t) {
		...
		for (let t of n) if (t.luigiMfId === e) {
			t.sendCustomMessage ? t.sendCustomMessage(r, i) : console.warn("Container does not support sending custom messages:", t);
			return;
		}
	...
	setConfig = (e) => {
		this.config = e, this.setConfigCallback(this.getConfigReadyCallback()), ki.init().then(() => {
	...
	clearNavigationCache() {
		...
		let e = (t) => {
			t && t.forEach && t.forEach((t) => {
				t.titleResolver && t.titleResolver._cache && (t.titleResolver._cache = void 0), t.children && e(t.children);
			});
		};
		e(this.getConfig().navigation.nodes);
	}
	setGlobalContext(e, t) {
		this.config && this.config.navigation && (this.config.navigation.globalContext = e, t || this.configChanged("navigation"));
	}
	getGlobalContext() {
	...
	async readUserSettings() {
		let e = await this.getConfigValueAsync("userSettings") || await this.getConfigValueAsync("settings.userSettings");
	...
	async storeUserSettings(e, t) {
		let n = await this.getConfigValueAsync("userSettings") || await this.getConfigValueAsync("settings.userSettings");
	...
	unload() {
		this.initialized = !1, window.Luigi._store.clear(), ki.unload(), xi.removeAllEventListeners(), this.getEngine()._connector?.unload(), this._i18n = void 0;
	}
...
}, Ki = Array.isArray, qi = Array.prototype.indexOf, Ji = Array.prototype.includes, Yi = Array.from, Xi = Object.defineProperty, Zi = Object.getOwnPropertyDescriptor, Qi = Object.prototype, $i = Array.prototype, ea = Object.getPrototypeOf, ta = Object.isExtensible, na = () => {};
function ra(e) {
	for (var t = 0; t < e.length; t++) e[t]();
}
function ia() {
...
var aa = 1024, oa = 2048, sa = 4096, ca = 8192, la = 16384, ua = 32768, da = 1 << 25, fa = 65536, pa = 1 << 19, ma = 1 << 20, ha = 65536, ga = 1 << 21, _a = 1 << 23, va = Symbol("$state"), ya = Symbol("attributes"), ba = Symbol("class"), xa = Symbol("style"), Sa = Symbol("text"), Ca = new class extends Error {
	name = "StaleReactionError";
	message = "The reaction that called `getAbortSignal()` was re-run or destroyed";
}();
...
var io = !1, ao = null, oo = null, q = null, so = null, co = null, lo = null, uo = !1, fo = !1, po = null, mo = null, ho = 0, go = 1, _o = class e {
	id = go++;
	#e = !1;
	linked = !0;
	#t = null;
	...
	#v(e, t, n) {
		...
		for (var r = e.first; r !== null;) {
			...
			if (!(a && i & 1024 || i & 8192 || this.#p.has(r)) && r.fn !== null) {
				a ? r.f ^= aa : i & 4 ? t.push(r) : Ba && i & 16777224 ? n.push(r) : Ms(r) && (i & 16 && this.#f.add(r), Ls(r));
				var o = r.first;
				if (o !== null) {
					r = o;
					continue;
	...
	capture(e, t, n = !1) {
		e.v !== ka && !this.previous.has(e) && this.previous.set(e, e.v), e.f & 8388608 || (this.current.set(e, [t, n]), co?.set(e, t)), this.is_fork || (e.v = t);
	}
	activate() {
		q = this;
	}
		...
		for (let l = ao; l !== null; l = l.#n) {
			...
			if (l.#e) {
				...
				if (r.length === 0) e && l.discard();
					...
					if (s.length > 0) for (let e of this.#u) !(e.f & 155648) && So(e, s, a) && (e.f & 4194320 ? (eo(e, oa), l.schedule(e)) : l.#d.add(e));
					if (l.#l.length > 0) {
						l.apply();
	...
	apply() {
		...
		for (let t = ao; t !== null; t = t.#n) if (!(t === this || t.is_fork)) {
			var e = !1;
			if (t.id < this.id) {
...
function bo(e) {
	...
	if (t !== 0) {
		for (var n = 0; n < t;) {
			var r = e[n++];
			if (!(r.f & 24576) && Ms(r) && (yo = /* @__PURE__ */ new Set(), Ls(r), r.deps === null && r.first === null && r.nodes === null && r.teardown === null && r.ac === null && us(r), yo?.size > 0)) {
				Io.clear();
				for (let e of yo) {
...
var ko = class {
	...
	constructor(e, t, n, r) {
		this.#e = e, this.#n = t, this.#r = (e) => {
			var t = X;
			t.b = this, t.f |= 128, n(e);
		}, this.parent = X.b, this.transform_error = r ?? this.parent?.transform_error ?? ((e) => e), this.#i = rs(() => {
			if (Na) {
				let e = this.#t;
				Ia();
				let t = e.data === "[!";
	...
	#v() {
		let e = this.#n.pending;
		e && (this.is_pending = !0, this.#o = is(() => e(this.#e)), Xa(() => {
			var e = this.#c = document.createDocumentFragment(), t = Yo();
			e.append(t), this.#a = this.#x(() => is(() => this.#r(t))), this.#u === 0 && (this.#e.before(e), this.#c = null, ds(this.#o, () => {
				this.#o = null;
			}), this.#b(q));
		}));
	}
	#y() {
		try {
			if (this.is_pending = this.has_pending_snippet(), this.#u = 0, this.#l = 0, this.#a = is(() => {
				this.#r(this.#e);
			}), this.#u > 0) {
				var e = this.#c = document.createDocumentFragment();
				ps(this.#a, e);
	...
	#S(e, t) {
		...
		this.#u += e, this.#u === 0 && (this.#b(t), this.#o && ds(this.#o, () => {
			this.#o = null;
		}), this.#c &&= (this.#e.before(this.#c), null));
	}
	update_pending_count(e, t) {
		this.#S(e, t), this.#l += e, !(!this.#m || this.#d) && (this.#d = !0, Xa(() => {
	...
	error(e) {
		if (!this.#n.onerror && !this.#n.failed) throw e;
		q?.is_fork ? (this.#a && q.skip_effect(this.#a), this.#o && q.skip_effect(this.#o), this.#s && q.skip_effect(this.#s), q.on_fork_commit(() => {
			this.#C(e);
		})) : this.#C(e);
	}
	#C(e) {
		this.#a &&= (cs(this.#a), null), this.#o &&= (cs(this.#o), null), this.#s &&= (cs(this.#s), null), Na && (Fa(this.#t), La(), Fa(Ra()));
		var t = this.#n.onerror;
		let n = this.#n.failed;
		var r = !1, i = !1;
		let a = () => {
			...
			r = !0, i && Oa(), this.#s !== null && ds(this.#s, () => {
				this.#s = null;
			}), this.#x(() => {
				this.#y();
			});
		...
		Xa(() => {
			...
			typeof t == "object" && t && typeof t.then == "function" ? t.then(o, (e) => Qa(e, this.#i && this.#i.parent)) : o(t);
		});
	}
};
function Ao(e) {
...
function Mo(e) {
	var t = jo(e);
	if (!e.equals(t) && (e.wv = js(), (!q?.is_fork || e.deps === null) && (q === null ? e.v = t : (q.capture(e, t, !0), so?.capture(e, t, !0)), e.deps === null))) {
		eo(e, aa);
		return;
	}
...
function No(e) {
	if (e.effects !== null) for (let t of e.effects) (t.teardown || t.ac) && (t.teardown?.(), t.ac?.abort(Ca), t.teardown = na, t.ac = null, Is(t, 0), os(t));
}
function Po(e) {
...
var Fo = /* @__PURE__ */ new Set(), Io = /* @__PURE__ */ new Map(), Lo = !1;
function Ro(e, t) {
	return {
		f: 0,
		v: e,
...
function Bo(e, t, n = !1) {
	return Y !== null && (!vs || Y.f & 131072) && qa() && Y.f & 4325394 && (xs === null || !Ji.call(xs, e)) && Da(), Vo(e, n ? Go(t) : t, mo);
}
function Vo(e, t, n = null) {
	if (!e.equals(t)) {
		...
		e.wv = js(), Wo(e, oa, n), qa() && X !== null && X.f & 1024 && !(X.f & 96) && (Ts === null ? Es([e]) : Ts.push(e)), !r.is_fork && Fo.size > 0 && !Lo && Ho();
	}
	return t;
}
function Ho() {
...
function Wo(e, t, n) {
	var r = e.reactions;
	if (r !== null) for (var i = qa(), a = r.length, o = 0; o < a; o++) {
		var s = r[o], c = s.f;
		if (!(!i && s === X)) {
			var l = (c & oa) === 0;
...
function Go(e) {
	...
	var n = /* @__PURE__ */ new Map(), r = Ki(e), i = /* @__PURE__ */ zo(0), a = null, o = ks, s = (e) => {
		if (ks === o) return e();
		var t = Y, n = ks;
		ys(null), As(o);
		var r = e();
	...
	return r && n.set("length", /* @__PURE__ */ zo(e.length, a)), new Proxy(e, {
		defineProperty(e, t, r) {
		...
		get(t, r, i) {
			...
			if (o === void 0 && (!c || Zi(t, r)?.writable) && (o = s(() => /* @__PURE__ */ zo(Go(c ? t[r] : ka), a)), n.set(r, o)), o !== void 0) {
				var l = Rs(o);
		...
		has(e, t) {
			if (t === va) return !0;
			var r = n.get(t), i = r !== void 0 && r.v !== ka || Reflect.has(e, t);
			return (r !== void 0 || X !== null && (!i || Zi(e, t)?.writable)) && (r === void 0 && (r = s(() => /* @__PURE__ */ zo(i ? Go(e[t]) : ka, a)), n.set(t, r)), Rs(r) === ka) ? !1 : i;
		},
		set(e, t, o, c) {
			var l = n.get(t), u = t in e;
			...
			if (l === void 0) (!u || Zi(e, t)?.writable) && (l = s(() => /* @__PURE__ */ zo(void 0, a)), Bo(l, Go(o)), n.set(t, l));
			else {
				u = l.v !== ka;
				var p = s(() => Go(o));
				Bo(l, p);
...
function Jo() {
	if (Ko === void 0) {
		...
		var e = Element.prototype, t = Node.prototype, n = Text.prototype;
		Zi(t, "firstChild").get, qo = Zi(t, "nextSibling").get, ta(e) && (e[ba] = void 0, e[ya] = null, e[xa] = void 0, e.__e = void 0), ta(n) && (n[Sa] = void 0);
	}
}
function Yo(e = "") {
	return document.createTextNode(e);
...
function Qo(e, t) {
	...
	if (e & 4) po === null ? _o.ensure().schedule(r) : po.push(r);
		...
		i.deps === null && i.teardown === null && i.nodes === null && i.first === i.last && !(i.f & 524288) && (i = i.first, e & 16 && e & 65536 && i !== null && (i.f |= fa));
	}
...
function cs(e, t = !0) {
	var n = !1;
	(t || e.f & 262144) && e.nodes !== null && e.nodes.end !== null && (ls(e.nodes.start, e.nodes.end), n = !0), eo(e, da), os(e, t && !n), Is(e, 0);
	var r = e.nodes && e.nodes.t;
	if (r !== null) for (let e of r) e.stop();
	as(e), e.f ^= da, e.f |= la;
	var i = e.parent;
	i !== null && i.first !== null && us(e), e.next = e.prev = e.teardown = e.ctx = e.deps = e.fn = e.nodes = e.ac = e.b = null;
}
function ls(e, t) {
	for (; e !== null;) {
...
function Ns(e, t, n = !0) {
	var r = e.reactions;
	if (r !== null && !(!Ba && xs !== null && Ji.call(xs, e))) for (var i = 0; i < r.length; i++) {
		var a = r[i];
		a.f & 2 ? Ns(a, t, !1) : t === a && (n ? eo(a, oa) : a.f & 1024 && eo(a, sa), Co(a));
	}
}
function Ps(e) {
	var t = Cs, n = ws, r = Ts, i = Y, a = xs, o = Ua, s = vs, c = ks, l = e.f;
	Cs = null, ws = 0, Ts = null, Y = l & 96 ? null : e, xs = null, Wa(e.ctx), vs = !1, ks = ++Os, e.ac !== null && (J(() => {
		e.ac.abort(Ca);
	}), e.ac = null);
	try {
		e.f |= ga;
		var u = e.fn, d = u();
		e.f |= ua;
		var f = e.deps, p = q?.is_fork;
		if (Cs !== null) {
			var m;
			if (p || Is(e, ws), f !== null && ws > 0) for (f.length = ws + Cs.length, m = 0; m < Cs.length; m++) f[ws + m] = Cs[m];
			else e.deps = f = Cs;
...
function Rs(e) {
	...
	if (ms?.add(e), Y !== null && !vs && !(X !== null && X.f & 16384) && (xs === null || !Ji.call(xs, e))) {
		var n = Y.deps;
		if (Y.f & 2097152) e.rv < Os && (e.rv = Os, Cs === null && n !== null && n[ws] === e ? ws++ : Cs === null ? Cs = [e] : Cs.push(e));
		else {
			(Y.deps ??= []).push(e);
			var r = e.reactions;
	...
	if (t) {
		...
		var o = (i.f & 512) == 0 && !vs && Y !== null && (hs || (Y.f & 512) != 0), s = (i.f & ua) === 0;
...
function zs(e) {
	if (e.f |= 512, e.deps !== null) for (let t of e.deps) (t.reactions ??= []).push(e), t.f & 2 && !(t.f & 512) && (Po(t), zs(t));
}
function Bs(e) {
	if (e.v === ka) return !0;
	if (e.deps === null) return !1;
...
var Ws = Symbol("events"), Gs = /* @__PURE__ */ new Set(), Ks = /* @__PURE__ */ new Set(), qs = null;
function Js(e) {
	var t = this, n = t.ownerDocument, r = e.type, i = e.composedPath?.() || [], a = i[0] || e.target;
	qs = e;
	var o = 0, s = qs === e && e[Ws];
...
function Qs(e, { target: t, anchor: n, props: r = {}, events: i, context: a, intro: o = !0, transformError: s }) {
	...
	var c = void 0, l = ts(() => {
		...
		Oo(o, { pending: () => {} }, (t) => {
			Ga({});
			var n = Ua;
			if (a && (n.c = a), i && (r.$$events = i), Na && Ys(t, null), c = e(t, r) || {}, Na && (X.nodes.end = Pa, Pa === null || Pa.nodeType !== 8 || Pa.data !== "]")) throw ja(), K;
			Ka();
		}, s);
		var l = /* @__PURE__ */ new Set(), u = (e) => {
			for (var n = 0; n < e.length; n++) {
		...
		return u(Yi(Gs)), Ks.add(u), () => {
			for (var e of l) for (let n of [t, document]) {
				var r = Zs.get(n), i = r.get(e);
...
var tc = {
	...
	handleExternalLinkNavigation: (e) => {
		if (e.url) if (e.sameWindow) window.location.href = e.url;
		else {
	...
	async addSearchParamsFromClient(e, t, n, r) {
		let i = W.get(yi), a = U.getCurrentPath(r, r.getConfig().routing?.useHashRouting), o = (await i.getCurrentNode(a.path))?.clientPermissions?.urlParameters, s = { ...e };
		if (o) {
			let e = {};
	...
	processAlert: (e, t, n) => {
		...
		let r = {
			...
			link: (t) => {
				if (e.links) {
					let r = e.links[t];
					if (r && (r.url && rc.luigi?.navigation().navigate(r.url), r.dismissKey && e.id)) return n.notifyAlertClosed(e.id, r.dismissKey), !0;
				}
				return !1;
			}
		};
	...
	handleConfirmationModalRequest: (e, t) => {
		...
		if (e) {
			...
			e = {
				...
				buttonConfirm: e.buttonConfirm === !1 ? !1 : rc.luigi.i18n().getTranslation(e.buttonConfirm || "luigi.button.confirm")
			};
		}
	...
	static hasLocaleChangePermission(e) {
		return e?.clientPermissions?.changeCurrentLocale ? !0 : (console.error("Current locale change declined from client, as client permission \"changeCurrentLocale\" is not set for this view."), !1);
	}
};
//#endregion
...
var oc = {
	...
	addListeners: (e, t) => {
		e.addEventListener(V.INITIALIZED, (t) => {
			...
			let { drawer: t, link: n, intent: r, preserveView: i, modal: a, newTab: o, withoutSync: s, preventContextUpdate: c, preventHistoryEntry: l, fromVirtualTreeRoot: u, fromContext: d, fromClosestContext: f, fromParent: p, relative: m, nodeParams: h } = e.detail, g = {
				drawerSettings: t,
				intent: r,
				modalSettings: a,
				newTab: o,
			...
			let t = e.payload;
			W.get(yi).getCurrentRoutePath(t).then((t) => {
				e.callback(t);
			}).catch(() => e.callback(""));
...
window.Luigi = new Gi(new class {
	...
	init() {
		let e = window.Luigi;
		W.register(gi, () => new gi(e)), W.register(Ii, () => new Ii(e)), W.register(yi, () => new yi(e)), W.register(vi, () => new vi()), W.register(Si, () => new Si(e)), W.register(Ci, () => new Ci()), W.register(_i, () => new _i(e)), W.register(bi, () => new bi(e)), e.theming()._init(), G.init(e), tc.init(e), oc.init(e), rc.init(e);
	}
}());
//#endregion
