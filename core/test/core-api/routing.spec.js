...
describe('Luigi routing', function () {
  ...
  describe('SearchParams path routing', () => {
    ...
    it('get searchparams', () => {
      window.location.href = 'http://some.url.de?test=tets&luigi=rocks';
      assert.deepEqual(LuigiRouting.getSearchParams(), { test: 'tets', luigi: 'rocks' });
    });
    it('get searchparams extended', () => {
      window.location.href = 'http://some.url.de/something?test=tets&luigi=rocks';
      assert.deepEqual(LuigiRouting.getSearchParams(), { test: 'tets', luigi: 'rocks' });
    });
    it('get searchparams when no query parameter', () => {
      window.location.href = 'http://some.url.de';
    ...
    it('add search params to searchparams', () => {
      window.state = {};
      window.location.href = 'http://some.url.de?test=tets';
      LuigiRouting.addSearchParams({ foo: 'bar' }, true);
    ...
    it('delete search params from url with keepBrowserHistory is true', () => {
      window.state = {};
      window.location.href = 'http://some.url.de?luigi=rocks&mario=red';
  ...
  describe('SearchParams hash routing', () => {
    ...
    it('get searchparams avoiding prototype pollution', () => {
      window.location.href = 'http://some.url.de/#/?test=tets&luigi=rocks&__proto__=polluted';
      assert.deepEqual(LuigiRouting.getSearchParams(), { test: 'tets', luigi: 'rocks' });
    });
    ...
    it('add search params to hash routing', () => {
      window.state = {};
      window.location.href = 'http://some.url.de/#/?~luigi=rocks';
      LuigiRouting.addSearchParams({ foo: 'bar' }, true);
      sinon.assert.calledWithExactly(
        window.history.pushState,
        window.state,
  ...
  describe('Anchor with hash routing', () => {
    ...
    it('get anchor', () => {
      window.location.href = 'http://some.url.de/#/luigi#myanchor';
    ...
    it('set anchor', () => {
      window.location.href = 'http://some.url.de/#/luigi';
