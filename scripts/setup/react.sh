...
npm i -P @luigi-project/core @luigi-project/client fundamental-styles@0.11.0 @sap-theming/theming-base-content react-router-dom@6
npm i copy-webpack-plugin@6 webpack@5 webpack-cli@4 @babel/core @babel/preset-env babel-loader --save-dev --legacy-peer-deps
