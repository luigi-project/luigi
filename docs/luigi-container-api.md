...
* **since:** 1.0.0
### webcomponent&nbsp;  
<p>Predicate that sets whether the microfrontend is to be rendered in a web component or not. It can also be an object with the attributes shown in a table below. <br><br>Type: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">Boolean</a> | WebComponentSettings | <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">String</a></p>
...
- [WebComponentSettings] <code>Object</code> - <p>specifies that the microfrontend is a webcomponent with addtional settings</p>
    - .type <code>string</code> - <p>a string, like module</p>
